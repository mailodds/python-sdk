...
> DeletePolicyRule200Response delete_blacklist_monitor(monitor_id)
...
with mailodds.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a blacklist monitor
        api_response = api_instance.delete_blacklist_monitor(monitor_id)
        print("The response of BlacklistMonitoringApi->delete_blacklist_monitor:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BlacklistMonitoringApi->delete_blacklist_monitor: %s\n" % e)
```
