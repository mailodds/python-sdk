...
with mailodds.ApiClient(configuration) as api_client:
    ...
    api_instance = mailodds.EventDestinationsApi(api_client)

    try:
        # Create an event destination
        api_instance.create_event_destination()
    except Exception as e:
        print("Exception when calling EventDestinationsApi->create_event_destination: %s\n" % e)
```
...
with mailodds.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete an event destination
        api_instance.delete_event_destination(destination_id)
    except Exception as e:
        print("Exception when calling EventDestinationsApi->delete_event_destination: %s\n" % e)
```
...
with mailodds.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an event destination
        api_instance.get_event_destination(destination_id)
    except Exception as e:
        print("Exception when calling EventDestinationsApi->get_event_destination: %s\n" % e)
```
...
with mailodds.ApiClient(configuration) as api_client:
    ...
    try:
        # List event destination templates
        api_instance.list_event_destination_templates()
    except Exception as e:
        print("Exception when calling EventDestinationsApi->list_event_destination_templates: %s\n" % e)
```
...
with mailodds.ApiClient(configuration) as api_client:
    ...
    try:
        # List event destinations
        api_instance.list_event_destinations()
    except Exception as e:
        print("Exception when calling EventDestinationsApi->list_event_destinations: %s\n" % e)
```
...
with mailodds.ApiClient(configuration) as api_client:
    ...
    try:
        # List event schemas
        api_instance.list_event_schemas()
    except Exception as e:
        print("Exception when calling EventDestinationsApi->list_event_schemas: %s\n" % e)
```
...
with mailodds.ApiClient(configuration) as api_client:
    ...
    try:
        # Update an event destination
        api_instance.update_event_destination(destination_id)
    except Exception as e:
        print("Exception when calling EventDestinationsApi->update_event_destination: %s\n" % e)
```
