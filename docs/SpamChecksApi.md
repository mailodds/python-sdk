...
# **delete_spam_check**
> DeletePolicyRule200Response delete_spam_check(check_id)
...
with mailodds.ApiClient(configuration) as api_client:
    ...
    check_id = 'check_id_example' # str | Spam check ID

    try:
        # Delete spam check
        api_response = api_instance.delete_spam_check(check_id)
        print("The response of SpamChecksApi->delete_spam_check:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SpamChecksApi->delete_spam_check: %s\n" % e)
```
