...
class AgentControlPlaneApi:
    ...
    def get_mcp_capabilities(
        ...
        _param = self._get_mcp_capabilities_serialize(
    ...
    @validate_call
    def get_mcp_capabilities_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_mcp_capabilities_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_mcp_capabilities_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/mcp/capabilities',
