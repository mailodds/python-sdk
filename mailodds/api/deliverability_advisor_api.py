...
class DeliverabilityAdvisorApi:
    ...
    @validate_call
    def dismiss_deliverability_recommendation(
        self,
        ...
        _param = self._dismiss_deliverability_recommendation_serialize(
    ...
    @validate_call
    def dismiss_deliverability_recommendation_with_http_info(
        self,
        recommendation_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def dismiss_deliverability_recommendation_without_preload_content(
        self,
        recommendation_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _dismiss_deliverability_recommendation_serialize(
        self,
        recommendation_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/deliverability/recommendations/{recommendation_id}/dismiss',
    ...
    def get_deliverability_recommendations(
        ...
        _param = self._get_deliverability_recommendations_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_deliverability_recommendations_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_deliverability_recommendations_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_deliverability_recommendations_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/deliverability/recommendations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
