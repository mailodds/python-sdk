...
class DKIMManagementApi:
    ...
    def get_dkim_dns_record(
        ...
        _param = self._get_dkim_dns_record_serialize(
            domain_id=domain_id,
    ...
    @validate_call
    def get_dkim_dns_record_with_http_info(
        self,
        domain_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_dkim_dns_record_without_preload_content(
        self,
        domain_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_dkim_dns_record_serialize(
        self,
        domain_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/sending-domains/{domain_id}/dkim/dns-record',
    ...
    def rotate_dkim(
        ...
        _param = self._rotate_dkim_serialize(
            domain_id=domain_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def rotate_dkim_with_http_info(
        self,
        domain_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def rotate_dkim_without_preload_content(
        self,
        domain_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _rotate_dkim_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/sending-domains/{domain_id}/dkim/rotate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
