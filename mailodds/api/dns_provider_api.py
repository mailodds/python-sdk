...
class DNSProviderApi:
    ...
    @validate_call
    def connect_dns_provider(
        self,
        connect_dns_provider_request: ConnectDnsProviderRequest,
        ...
        :param connect_dns_provider_request: (required)
        :type connect_dns_provider_request: ConnectDnsProviderRequest
        ...
        _param = self._connect_dns_provider_serialize(
            connect_dns_provider_request=connect_dns_provider_request,
    ...
    @validate_call
    def connect_dns_provider_with_http_info(
        self,
        connect_dns_provider_request: ConnectDnsProviderRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def connect_dns_provider_without_preload_content(
        self,
        connect_dns_provider_request: ConnectDnsProviderRequest,
        _request_timeout: Union[
            None,
    ...
    def _connect_dns_provider_serialize(
        self,
        connect_dns_provider_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if connect_dns_provider_request is not None:
            _body_params = connect_dns_provider_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/account/dns-provider',
    ...
    def disconnect_dns_provider(
        ...
        _param = self._disconnect_dns_provider_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def disconnect_dns_provider_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def disconnect_dns_provider_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _disconnect_dns_provider_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_dns_provider(
        ...
        _param = self._get_dns_provider_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_dns_provider_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_dns_provider_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_dns_provider_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
