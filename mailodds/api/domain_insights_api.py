...
class DomainInsightsApi:
    ...
    @validate_call
    def get_domain_hook_effectiveness(
        self,
        domain_id: Annotated[StrictStr, Field(description="Sending domain ID")],
        days: Annotated[Optional[Annotated[int, Field(le=90, strict=True, ge=1)]], Field(description="Lookback period in days")] = None,
        ...
        _param = self._get_domain_hook_effectiveness_serialize(
            domain_id=domain_id,
            days=days,
    ...
    @validate_call
    def get_domain_hook_effectiveness_with_http_info(
        self,
        domain_id: Annotated[StrictStr, Field(description="Sending domain ID")],
        days: Annotated[Optional[Annotated[int, Field(le=90, strict=True, ge=1)]], Field(description="Lookback period in days")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDomainHookEffectiveness200Response]:
        """Get hook effectiveness metrics
    ...
    @validate_call
    def get_domain_hook_effectiveness_without_preload_content(
        self,
        domain_id: Annotated[StrictStr, Field(description="Sending domain ID")],
        days: Annotated[Optional[Annotated[int, Field(le=90, strict=True, ge=1)]], Field(description="Lookback period in days")] = None,
        _request_timeout: Union[
    ...
    def _get_domain_hook_effectiveness_serialize(
        self,
        domain_id,
        days,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/sending-domains/{domain_id}/insights/hook-effectiveness',
    ...
    @validate_call
    def get_domain_insights_funnel(
        self,
        domain_id: Annotated[StrictStr, Field(description="Sending domain ID")],
        days: Annotated[Optional[Annotated[int, Field(le=90, strict=True, ge=1)]], Field(description="Lookback period in days")] = None,
        _request_timeout: Union[
        ...
        _param = self._get_domain_insights_funnel_serialize(
            domain_id=domain_id,
            days=days,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_domain_insights_funnel_with_http_info(
        self,
        domain_id: Annotated[StrictStr, Field(description="Sending domain ID")],
        days: Annotated[Optional[Annotated[int, Field(le=90, strict=True, ge=1)]], Field(description="Lookback period in days")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDomainInsightsFunnel200Response]:
        """Get domain engagement funnel
    ...
    @validate_call
    def get_domain_insights_funnel_without_preload_content(
        self,
        domain_id: Annotated[StrictStr, Field(description="Sending domain ID")],
        days: Annotated[Optional[Annotated[int, Field(le=90, strict=True, ge=1)]], Field(description="Lookback period in days")] = None,
        _request_timeout: Union[
    ...
    def _get_domain_insights_funnel_serialize(
        self,
        domain_id,
        days,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/sending-domains/{domain_id}/insights/funnel',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_domain_insights_trends(
        self,
        domain_id: Annotated[StrictStr, Field(description="Sending domain ID")],
        days: Annotated[Optional[Annotated[int, Field(le=90, strict=True, ge=1)]], Field(description="Lookback period in days")] = None,
        _request_timeout: Union[
        ...
        _param = self._get_domain_insights_trends_serialize(
            domain_id=domain_id,
            days=days,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_domain_insights_trends_with_http_info(
        self,
        domain_id: Annotated[StrictStr, Field(description="Sending domain ID")],
        days: Annotated[Optional[Annotated[int, Field(le=90, strict=True, ge=1)]], Field(description="Lookback period in days")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDomainInsightsTrends200Response]:
        """Get domain engagement trends
    ...
    @validate_call
    def get_domain_insights_trends_without_preload_content(
        self,
        domain_id: Annotated[StrictStr, Field(description="Sending domain ID")],
        days: Annotated[Optional[Annotated[int, Field(le=90, strict=True, ge=1)]], Field(description="Lookback period in days")] = None,
        _request_timeout: Union[
    ...
    def _get_domain_insights_trends_serialize(
        self,
        domain_id,
        days,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/sending-domains/{domain_id}/insights/trends',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
