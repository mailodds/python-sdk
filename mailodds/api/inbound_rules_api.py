...
class InboundRulesApi:
    ...
    def _create_inbound_rule_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/sending-domains/{domain_id}/inbound-rules',
    ...
    def _delete_inbound_rule_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/sending-domains/{domain_id}/inbound-rules/{rule_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def dry_run_inbound_rules(
        ...
        _param = self._dry_run_inbound_rules_serialize(
            domain_id=domain_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def dry_run_inbound_rules_with_http_info(
        self,
        domain_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def dry_run_inbound_rules_without_preload_content(
        self,
        domain_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _dry_run_inbound_rules_serialize(
        self,
        domain_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/sending-domains/{domain_id}/inbound-rules/dry-run',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_inbound_rule(
        ...
        _param = self._get_inbound_rule_serialize(
            domain_id=domain_id,
            rule_id=rule_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_inbound_rule_with_http_info(
        self,
        domain_id: StrictStr,
        rule_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_inbound_rule_without_preload_content(
        self,
        domain_id: StrictStr,
        rule_id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_inbound_rule_serialize(
        self,
        domain_id,
        rule_id,
        _request_auth,
    ...
    def update_inbound_rule(
        ...
        _param = self._update_inbound_rule_serialize(
            domain_id=domain_id,
            rule_id=rule_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_inbound_rule_with_http_info(
        self,
        domain_id: StrictStr,
        rule_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def update_inbound_rule_without_preload_content(
        self,
        domain_id: StrictStr,
        rule_id: StrictStr,
        _request_timeout: Union[
    ...
    def _update_inbound_rule_serialize(
        self,
        domain_id,
        rule_id,
        _request_auth,
