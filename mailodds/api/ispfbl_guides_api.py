...
class ISPFBLGuidesApi:
    ...
    def get_isp_fbl_guide(
        ...
        _param = self._get_isp_fbl_guide_serialize(
            isp_id=isp_id,
    ...
    @validate_call
    def get_isp_fbl_guide_with_http_info(
        self,
        isp_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_isp_fbl_guide_without_preload_content(
        self,
        isp_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_isp_fbl_guide_serialize(
        self,
        isp_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/isp-fbl/guides/{isp_id}',
    ...
    def list_isp_fbl_guides(
        ...
        _param = self._list_isp_fbl_guides_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_isp_fbl_guides_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_isp_fbl_guides_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_isp_fbl_guides_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/isp-fbl/guides',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
