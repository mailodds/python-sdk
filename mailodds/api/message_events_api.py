...
class MessageEventsApi:
    ...
    def get_message_events(
        self,
        message_id: Annotated[StrictStr, Field(description="UUID of the sent message")],
        ...
        :param message_id: UUID of the sent message (required)
        :type message_id: str
        ...
        _param = self._get_message_events_serialize(
    ...
    @validate_call
    def get_message_events_with_http_info(
        self,
        message_id: Annotated[StrictStr, Field(description="UUID of the sent message")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetMessageEvents200Response]:
        """Get message events
    ...
    @validate_call
    def get_message_events_without_preload_content(
        self,
        message_id: Annotated[StrictStr, Field(description="UUID of the sent message")],
        _request_timeout: Union[
            None,
    ...
    def _get_message_events_serialize(
        self,
        message_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/message-events',
