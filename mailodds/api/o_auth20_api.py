...
class OAuth20Api:
    ...
    def oauth_register_client(
        ...
        _param = self._oauth_register_client_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def oauth_register_client_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OAuthClientRegistration]:
        """Register OAuth client
    ...
    @validate_call
    def oauth_register_client_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _oauth_register_client_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
