...
class PixelSettingsApi:
    ...
    def get_pixel_settings(
        ...
        _param = self._get_pixel_settings_serialize(
    ...
    @validate_call
    def get_pixel_settings_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPixelSettings200Response]:
        """Get pixel settings
    ...
    @validate_call
    def get_pixel_settings_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_pixel_settings_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/pixel-settings',
    ...
    @validate_call
    def update_pixel_settings(
        self,
        update_pixel_settings_request: UpdatePixelSettingsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param update_pixel_settings_request: (required)
        :type update_pixel_settings_request: UpdatePixelSettingsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_pixel_settings_serialize(
            update_pixel_settings_request=update_pixel_settings_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_pixel_settings_with_http_info(
        self,
        update_pixel_settings_request: UpdatePixelSettingsRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def update_pixel_settings_without_preload_content(
        self,
        update_pixel_settings_request: UpdatePixelSettingsRequest,
        _request_timeout: Union[
            None,
    ...
    def _update_pixel_settings_serialize(
        self,
        update_pixel_settings_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_pixel_settings_request is not None:
            _body_params = update_pixel_settings_request
