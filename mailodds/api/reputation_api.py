...
class ReputationApi:
    ...
    def get_reputation(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Evaluation period")] = None,
    ...
    def get_reputation_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetReputation200Response]:
        """Get account reputation
    ...
    def get_reputation_timeline(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Timeline period")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_reputation_timeline_serialize(
            period=period,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetReputationTimeline200Response",
            '401': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_reputation_timeline_with_http_info(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Timeline period")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetReputationTimeline200Response]:
        """Get reputation timeline
    ...
    @validate_call
    def get_reputation_timeline_without_preload_content(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Timeline period")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_reputation_timeline_serialize(
        self,
        period,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/reputation/timeline',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
