...
class SenderHealthApi:
    ...
    def get_sender_health(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Time period for health calculation")] = None,
        ...
        :param period: Time period for health calculation
        :type period: str
        ...
        _param = self._get_sender_health_serialize(
            period=period,
    ...
    @validate_call
    def get_sender_health_with_http_info(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Time period for health calculation")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSenderHealth200Response]:
        """Get sender health score
    ...
    @validate_call
    def get_sender_health_without_preload_content(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Time period for health calculation")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_sender_health_serialize(
        self,
        period,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/sender-health',
    ...
    @validate_call
    def get_sender_health_trend(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Time period for trend data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param period: Time period for trend data
        :type period: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_sender_health_trend_serialize(
            period=period,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_sender_health_trend_with_http_info(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Time period for trend data")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSenderHealthTrend200Response]:
        """Get sender health trend
    ...
    @validate_call
    def get_sender_health_trend_without_preload_content(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Time period for trend data")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_sender_health_trend_serialize(
        self,
        period,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/sender-health/trend',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
