...
class ServerTestsApi:
    ...
    def get_server_test(
        ...
        _param = self._get_server_test_serialize(
            test_id=test_id,
    ...
    def get_server_test_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RunServerTest201Response]:
        """Get server test
    ...
    def _get_server_test_serialize(
        self,
        test_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/server-tests/{test_id}',
    ...
    def list_server_tests(
        ...
        _param = self._list_server_tests_serialize(
            page=page,
            per_page=per_page,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListServerTests200Response",
            '401': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def list_server_tests_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        per_page: Optional[Annotated[int, Field(le=100, strict=True)]] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListServerTests200Response]:
        """List server tests
    ...
    @validate_call
    def list_server_tests_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        per_page: Optional[Annotated[int, Field(le=100, strict=True)]] = None,
        _request_timeout: Union[
    ...
    def _list_server_tests_serialize(
        self,
        page,
        per_page,
        _request_auth,
    ...
    def run_server_test(
        self,
        run_server_test_request: RunServerTestRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param run_server_test_request: (required)
        :type run_server_test_request: RunServerTestRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._run_server_test_serialize(
            run_server_test_request=run_server_test_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def run_server_test_with_http_info(
        self,
        run_server_test_request: RunServerTestRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_server_test_without_preload_content(
        self,
        run_server_test_request: RunServerTestRequest,
        _request_timeout: Union[
            None,
    ...
    def _run_server_test_serialize(
        self,
        run_server_test_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if run_server_test_request is not None:
            _body_params = run_server_test_request
