...
class SpamChecksApi:
    ...
    def delete_spam_check(
        ...
        _param = self._delete_spam_check_serialize(
            check_id=check_id,
    ...
    def _delete_spam_check_serialize(
        self,
        check_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/spam-checks/{check_id}',
    ...
    def get_spam_check(
        ...
        _param = self._get_spam_check_serialize(
            check_id=check_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def list_spam_checks(
        ...
        _param = self._list_spam_checks_serialize(
            page=page,
            per_page=per_page,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_spam_checks_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        per_page: Optional[Annotated[int, Field(le=100, strict=True)]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def list_spam_checks_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        per_page: Optional[Annotated[int, Field(le=100, strict=True)]] = None,
        _request_timeout: Union[
    ...
    def _list_spam_checks_serialize(
        self,
        page,
        per_page,
        _request_auth,
    ...
    def run_spam_check(
        self,
        run_spam_check_request: RunSpamCheckRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._run_spam_check_serialize(
            run_spam_check_request=run_spam_check_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def run_spam_check_with_http_info(
        self,
        run_spam_check_request: RunSpamCheckRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_spam_check_without_preload_content(
        self,
        run_spam_check_request: RunSpamCheckRequest,
        _request_timeout: Union[
            None,
    ...
    def _run_spam_check_serialize(
        self,
        run_spam_check_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if run_spam_check_request is not None:
            _body_params = run_spam_check_request
