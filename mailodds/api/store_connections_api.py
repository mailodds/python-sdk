...
class StoreConnectionsApi:
    ...
    def get_sync_job_errors(
        ...
        _param = self._get_sync_job_errors_serialize(
            store_id=store_id,
            job_id=job_id,
            page=page,
            per_page=per_page,
    ...
    def get_sync_job_errors_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSyncJobErrors200Response]:
        """Get sync job errors
    ...
    def _get_sync_job_errors_serialize(
        self,
        store_id,
        job_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/stores/{store_id}/sync-jobs/{job_id}/errors',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_sync_jobs(
        ...
        _param = self._list_sync_jobs_serialize(
            store_id=store_id,
            page=page,
            per_page=per_page,
            _request_auth=_request_auth,
    ...
    def list_sync_jobs_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListSyncJobs200Response]:
        """List sync jobs
    ...
    def _list_sync_jobs_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/stores/{store_id}/sync-jobs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
