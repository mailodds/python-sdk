...
class AddBlacklistMonitorRequest(BaseModel):
    """
    AddBlacklistMonitorRequest
    """ # noqa: E501
    target: StrictStr = Field(description="IP address or domain to monitor")
    target_type: StrictStr = Field(description="Whether the target is an IP or domain")
    __properties: ClassVar[List[str]] = ["target", "target_type"]
