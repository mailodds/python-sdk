...
class AddDmarcDomain201Response(BaseModel):
    """
    AddDmarcDomain201Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    domain: Optional[DmarcDomain] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "domain": DmarcDomain.from_dict(obj["domain"]) if obj.get("domain") is not None else None
        })
        return _obj
