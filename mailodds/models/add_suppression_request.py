...
class AddSuppressionRequest(BaseModel):
    ...
    """ # noqa: E501
    entries: List[AddSuppressionRequestEntriesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [AddSuppressionRequestEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
