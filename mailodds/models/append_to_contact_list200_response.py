...
class AppendToContactList200Response(BaseModel):
    """
    ...
    added_count: Optional[StrictInt] = Field(default=None, description="Number of new emails added")
    candidate_count: Optional[StrictInt] = Field(default=None, description="Total candidates from jobs")
    duplicate_count: Optional[StrictInt] = Field(default=None, description="Duplicates skipped")
    breakdown: Optional[Dict[str, Any]] = Field(default=None, description="Per-status breakdown of candidates")
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "contact_list", "added_count", "candidate_count", "duplicate_count", "breakdown"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.contact_list:
            _dict['contact_list'] = self.contact_list.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact_list": ContactList.from_dict(obj["contact_list"]) if obj.get("contact_list") is not None else None,
            "added_count": obj.get("added_count"),
            "candidate_count": obj.get("candidate_count"),
            "duplicate_count": obj.get("duplicate_count"),
