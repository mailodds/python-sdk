...
class AppendToContactListRequest(BaseModel):
    """
    AppendToContactListRequest
    """ # noqa: E501
    source_job_ids: List[StrictStr] = Field(description="Validation job IDs to append from")
    include_catch_all: Optional[StrictBool] = Field(default=False, description="Include catch-all emails in addition to valid ones")
    __properties: ClassVar[List[str]] = ["source_job_ids", "include_catch_all"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "source_job_ids": obj.get("source_job_ids"),
            "include_catch_all": obj.get("include_catch_all") if obj.get("include_catch_all") is not None else False
        })
        return _obj
