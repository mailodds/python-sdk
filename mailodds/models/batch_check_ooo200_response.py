...
class BatchCheckOoo200Response(BaseModel):
    """
    BatchCheckOoo200Response
    """ # noqa: E501
    results: Optional[List[BatchCheckOoo200ResponseResultsInner]] = None
    total: Optional[StrictInt] = None
    ooo_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["results", "total", "ooo_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [BatchCheckOoo200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "total": obj.get("total"),
            "ooo_count": obj.get("ooo_count")
        })
        return _obj
