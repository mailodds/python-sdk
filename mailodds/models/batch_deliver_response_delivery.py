...
class BatchDeliverResponseDelivery(BaseModel):
    """
    Delivery routing info (present when status is queued)
    """ # noqa: E501
    pool: Optional[StrictStr] = Field(default=None, description="IP pool used")
    lane: Optional[StrictStr] = Field(default=None, description="Delivery lane (green or yellow)")
    queued_at: Optional[datetime] = Field(default=None, description="Timestamp when batch was queued")
    __properties: ClassVar[List[str]] = ["pool", "lane", "queued_at"]
