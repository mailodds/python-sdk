...
class BatchDeliverResponseRejectedInner(BaseModel):
    """
    BatchDeliverResponseRejectedInner
    """ # noqa: E501
    email: Optional[StrictStr] = None
    reason: Optional[StrictStr] = Field(default=None, description="Rejection reason (suppressed, validation_rejected)")
    status: Optional[StrictStr] = Field(default=None, description="Validation status if rejected by validation")
    sub_status: Optional[StrictStr] = Field(default=None, description="Validation sub-status if rejected by validation")
    __properties: ClassVar[List[str]] = ["email", "reason", "status", "sub_status"]
