...
class BatchProductsRequest(BaseModel):
    ...
    """ # noqa: E501
    products: Annotated[List[BatchProductsRequestProductsInner], Field(max_length=100)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": [BatchProductsRequestProductsInner.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
