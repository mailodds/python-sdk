...
class BatchProductsRequestProductsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["external_id", "title", "product_url", "sku", "description", "price_current", "price_original", "currency", "stock_status", "stock_quantity", "image_url", "additional_images", "categories", "tags", "variants"]
