...
class BatchProductsResponse(BaseModel):
    ...
    created: Optional[StrictInt] = Field(default=None, description="Products created")
    updated: Optional[StrictInt] = Field(default=None, description="Products updated")
    errored: Optional[StrictInt] = Field(default=None, description="Products that failed")
    errors: Optional[List[BatchProductsResponseErrorsInner]] = Field(default=None, description="Error details (max 20)")
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "created", "updated", "errored", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [BatchProductsResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
