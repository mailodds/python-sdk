...
class BlacklistMonitor(BaseModel):
    """
    BlacklistMonitor
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Monitor UUID")
    target: Optional[StrictStr] = Field(default=None, description="IP address or domain being monitored")
    target_type: Optional[StrictStr] = None
    status: Optional[StrictStr] = Field(default=None, description="Current status (clean, listed)")
    listed_count: Optional[StrictInt] = Field(default=None, description="Number of blacklists currently listing this target")
    last_checked_at: Optional[datetime] = None
    latest_check: Optional[BlacklistMonitorLatestCheck] = None
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "target", "target_type", "status", "listed_count", "last_checked_at", "latest_check", "created_at"]
    ...
    def target_type_validate_enum(cls, value):
        ...
        if value not in set(['ip', 'domain']):
            raise ValueError("must be one of enum values ('ip', 'domain')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of latest_check
        if self.latest_check:
            _dict['latest_check'] = self.latest_check.to_dict()
        ...
        # set to None if latest_check (nullable) is None
        # and model_fields_set contains the field
        if self.latest_check is None and "latest_check" in self.model_fields_set:
            _dict['latest_check'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "latest_check": BlacklistMonitorLatestCheck.from_dict(obj["latest_check"]) if obj.get("latest_check") is not None else None,
