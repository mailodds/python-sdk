...
class BounceAnalysisResponse(BaseModel):
    """
    ...
    analysis: Optional[BounceAnalysisResponseAnalysis] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "analysis"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "analysis": BounceAnalysisResponseAnalysis.from_dict(obj["analysis"]) if obj.get("analysis") is not None else None
        })
        return _obj
