...
class BounceAnalysisResponseAnalysisCategories(BaseModel):
    """
    Bounce category breakdown
    """ # noqa: E501
    invalid_recipient: Optional[StrictInt] = None
    mailbox_full: Optional[StrictInt] = None
    domain_issue: Optional[StrictInt] = None
    policy_rejection: Optional[StrictInt] = None
    content_rejection: Optional[StrictInt] = None
    other: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["invalid_recipient", "mailbox_full", "domain_issue", "policy_rejection", "content_rejection", "other"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invalid_recipient": obj.get("invalid_recipient"),
            "mailbox_full": obj.get("mailbox_full"),
            "domain_issue": obj.get("domain_issue"),
            "policy_rejection": obj.get("policy_rejection"),
            "content_rejection": obj.get("content_rejection"),
            "other": obj.get("other")
        })
        return _obj
