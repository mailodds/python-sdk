...
class BulkUpdateProductsRequest(BaseModel):
    ...
    """ # noqa: E501
    product_ids: Annotated[List[StrictStr], Field(max_length=500)] = Field(description="Product IDs to update")
    is_active: StrictBool = Field(description="Set product visibility")
    __properties: ClassVar[List[str]] = ["product_ids", "is_active"]
