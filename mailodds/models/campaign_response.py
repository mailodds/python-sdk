...
class CampaignResponse(BaseModel):
    ...
    variants: Optional[List[CampaignVariant]] = Field(default=None, description="Campaign variants. Present when fetching a single campaign.")
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "campaign", "variants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "variants": [CampaignVariant.from_dict(_item) for _item in obj["variants"]] if obj.get("variants") is not None else None
        })
        return _obj
