...
class CampaignVariant(BaseModel):
    ...
    CampaignVariant
    """ # noqa: E501
    id: StrictStr = Field(description="Variant UUID")
    campaign_id: StrictStr
    name: StrictStr = Field(description="Variant name (e.g., \"Variant A\")")
    subject: StrictStr
    ...
    weight: StrictInt = Field(description="Traffic weight percentage (all variant weights must sum to 100)")
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "campaign_id", "name", "subject", "html", "text", "weight", "created_at"]
