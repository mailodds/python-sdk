...
class ClassifyContent200Response(BaseModel):
    """
    ClassifyContent200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    content_check: Optional[ClassifyContent200ResponseContentCheck] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "content_check"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of content_check
        if self.content_check:
            _dict['content_check'] = self.content_check.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content_check": ClassifyContent200ResponseContentCheck.from_dict(obj["content_check"]) if obj.get("content_check") is not None else None
        })
        return _obj
