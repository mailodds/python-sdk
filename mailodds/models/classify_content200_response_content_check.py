...
class ClassifyContent200ResponseContentCheck(BaseModel):
    """
    ...
    def verdict_validate_enum(cls, value):
        ...
        if value not in set(['clean', 'warning', 'risky']):
            raise ValueError("must be one of enum values ('clean', 'warning', 'risky')")
        return value
