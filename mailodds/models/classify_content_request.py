...
class ClassifyContentRequest(BaseModel):
    ...
    html_body: Optional[StrictStr] = Field(default=None, description="HTML email body")
    content: Optional[StrictStr] = Field(default=None, description="Raw text content (alternative to subject+html_body)")
    __properties: ClassVar[List[str]] = ["subject", "html_body", "content"]
