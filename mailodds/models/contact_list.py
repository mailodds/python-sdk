...
class ContactList(BaseModel):
    ...
    ContactList
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Contact list UUID")
    name: Optional[StrictStr] = None
    email_count: Optional[StrictInt] = Field(default=None, description="Number of emails in the list")
    tags: Optional[List[StrictStr]] = None
    source_job_ids: Optional[List[StrictStr]] = Field(default=None, description="Validation job IDs this list was built from")
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "name", "email_count", "tags", "source_job_ids", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "email_count": obj.get("email_count"),
            "tags": obj.get("tags"),
