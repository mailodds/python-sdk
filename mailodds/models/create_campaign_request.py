...
class CreateCampaignRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=200)] = Field(description="Campaign name")
    list_id: StrictStr = Field(description="Target subscriber list UUID")
    domain_id: StrictStr = Field(description="Sending domain UUID")
    from_email: StrictStr = Field(description="Sender email address (must match the sending domain)")
    from_name: Optional[StrictStr] = Field(default=None, description="Sender display name")
    ...
    __properties: ClassVar[List[str]] = ["name", "list_id", "domain_id", "from_email", "from_name", "reply_to", "tags"]
