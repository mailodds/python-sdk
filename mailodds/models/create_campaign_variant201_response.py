...
class CreateCampaignVariant201Response(BaseModel):
    """
    ...
    variant: Optional[CampaignVariant] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "variant"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "variant": CampaignVariant.from_dict(obj["variant"]) if obj.get("variant") is not None else None
        })
        return _obj
