...
class CreateContactListRequest(BaseModel):
    ...
    source_job_id: Optional[StrictStr] = Field(default=None, description="Single validation job ID to build list from")
    source_job_ids: Optional[List[StrictStr]] = Field(default=None, description="Multiple validation job IDs to merge into one list")
    tags: Optional[List[StrictStr]] = Field(default=None, description="Tags for categorization")
    __properties: ClassVar[List[str]] = ["name", "source_job_id", "source_job_ids", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "source_job_id": obj.get("source_job_id"),
