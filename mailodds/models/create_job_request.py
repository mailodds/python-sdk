...
class CreateJobRequest(BaseModel):
    ...
    """ # noqa: E501
    emails: Annotated[List[StrictStr], Field(max_length=100000)] = Field(description="List of emails to validate")
    dedup: Optional[StrictBool] = Field(default=False, description="Remove duplicate emails")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Custom metadata for the job")
    webhook_url: Optional[StrictStr] = Field(default=None, description="URL for completion webhook. Payloads are signed with HMAC-SHA256 if a webhook secret is configured (see Webhooks section).")
    idempotency_key: Optional[StrictStr] = Field(default=None, description="Unique key for idempotent requests")
    __properties: ClassVar[List[str]] = ["emails", "dedup", "metadata", "webhook_url", "idempotency_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dedup": obj.get("dedup") if obj.get("dedup") is not None else False,
