...
class CreatePolicyFromPresetRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preset_id", "name", "is_default"]

    @field_validator('preset_id')
    def preset_id_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['strict', 'permissive', 'smtp_required']):
            raise ValueError("must be one of enum values ('strict', 'permissive', 'smtp_required')")
        return value
