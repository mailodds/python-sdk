...
class CreateSendingDomain201Response(BaseModel):
    """
    CreateSendingDomain201Response
    """ # noqa: E501
    domain: Optional[SendingDomain] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "domain": SendingDomain.from_dict(obj["domain"]) if obj.get("domain") is not None else None
        })
        return _obj
