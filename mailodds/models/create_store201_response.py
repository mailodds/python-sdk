...
class CreateStore201Response(BaseModel):
    """
    CreateStore201Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    store: Optional[StoreConnection] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "store"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "store": StoreConnection.from_dict(obj["store"]) if obj.get("store") is not None else None
        })
        return _obj
