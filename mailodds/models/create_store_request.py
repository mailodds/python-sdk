...
class CreateStoreRequest(BaseModel):
    ...
    CreateStoreRequest
    """ # noqa: E501
    platform: StrictStr = Field(description="E-commerce platform")
    store_name: StrictStr = Field(description="Display name for the store")
    store_url: StrictStr = Field(description="Store base URL")
    auth_method: StrictStr = Field(description="Authentication method")
    settings: Optional[Dict[str, Any]] = Field(default=None, description="Platform-specific settings (e.g., API keys, feed URL)")
    __properties: ClassVar[List[str]] = ["platform", "store_name", "store_url", "auth_method", "settings"]
