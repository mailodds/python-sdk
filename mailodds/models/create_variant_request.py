...
class CreateVariantRequest(BaseModel):
    ...
    weight: Annotated[int, Field(le=100, strict=True, ge=1)] = Field(description="Traffic weight percentage (all variant weights must sum to 100)")
    __properties: ClassVar[List[str]] = ["name", "subject", "html", "text", "weight"]
