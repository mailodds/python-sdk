...
class CreateWebhookCliSessionRequest(BaseModel):
    """
    CreateWebhookCliSessionRequest
    """ # noqa: E501
    forward_url: Optional[StrictStr] = Field(default=None, description="Local URL where webhooks will be forwarded")
    __properties: ClassVar[List[str]] = ["forward_url"]
