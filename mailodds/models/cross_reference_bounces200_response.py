...
class CrossReferenceBounces200Response(BaseModel):
    """
    CrossReferenceBounces200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    cross_reference: Optional[CrossReferenceBounces200ResponseCrossReference] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "cross_reference"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.cross_reference:
            _dict['cross_reference'] = self.cross_reference.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cross_reference": CrossReferenceBounces200ResponseCrossReference.from_dict(obj["cross_reference"]) if obj.get("cross_reference") is not None else None
        })
        return _obj
