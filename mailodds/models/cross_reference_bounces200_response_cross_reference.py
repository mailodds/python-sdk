...
class CrossReferenceBounces200ResponseCrossReference(BaseModel):
    """
    CrossReferenceBounces200ResponseCrossReference
    """ # noqa: E501
    total_bounced: Optional[StrictInt] = None
    matched: Optional[StrictInt] = Field(default=None, description="Bounced emails found in validation logs")
    unmatched: Optional[StrictInt] = Field(default=None, description="Bounced emails not in validation logs")
    match_rate: Optional[Union[StrictFloat, StrictInt]] = None
    entries: Optional[List[CrossReferenceBounces200ResponseCrossReferenceEntriesInner]] = None
    __properties: ClassVar[List[str]] = ["total_bounced", "matched", "unmatched", "match_rate", "entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total_bounced": obj.get("total_bounced"),
            "matched": obj.get("matched"),
            "unmatched": obj.get("unmatched"),
            "match_rate": obj.get("match_rate"),
            "entries": [CrossReferenceBounces200ResponseCrossReferenceEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
