...
class CrossReferenceBounces200ResponseCrossReferenceEntriesInner(BaseModel):
    """
    ...
    validation_status: Optional[StrictStr] = None
    validated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["email", "bounce_type", "bounced_at", "validation_status", "validated_at"]
