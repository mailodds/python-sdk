...
class DeliverRequest(BaseModel):
    ...
    schema_data: Optional[Dict[str, StrictStr]] = Field(default=None, description="Key-value pairs for campaign_type JSON-LD resolution (e.g., order_number, tracking_url)")
    auto_detect_schema: Optional[StrictBool] = Field(default=False, description="Auto-detect JSON-LD structured data type from subject line")
    ai_summary: Optional[Annotated[str, Field(strict=True, max_length=500)]] = Field(default=None, description="Hidden text summary for AI email assistants (max 500 characters)")
    options: Optional[DeliverRequestOptions] = None
    __properties: ClassVar[List[str]] = ["to", "from", "subject", "html", "text", "domain_id", "reply_to", "headers", "tags", "campaign_type", "structured_data", "schema_data", "auto_detect_schema", "ai_summary", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auto_detect_schema": obj.get("auto_detect_schema") if obj.get("auto_detect_schema") is not None else False,
