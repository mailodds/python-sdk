...
class DeliverRequestOptions(BaseModel):
    """
    DeliverRequestOptions
    """ # noqa: E501
    validate_first: Optional[StrictBool] = Field(default=None, description="Validate recipients before sending")
    __properties: ClassVar[List[str]] = ["validate_first"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validate_first": obj.get("validate_first")
        })
        return _obj
