...
class DeliverResponse(BaseModel):
    ...
    message_id: Optional[StrictStr] = Field(default=None, description="Unique message identifier")
    status: Optional[StrictStr] = Field(default=None, description="Delivery status")
    delivery: Optional[DeliverResponseDelivery] = None
    validation: Optional[Dict[str, Any]] = Field(default=None, description="Pre-send validation results (when validate_first is true)")
    content_scan: Optional[Dict[str, Any]] = Field(default=None, description="Content scan results")
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "message_id", "status", "delivery", "validation", "content_scan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "delivery": DeliverResponseDelivery.from_dict(obj["delivery"]) if obj.get("delivery") is not None else None,
            "validation": obj.get("validation"),
            "content_scan": obj.get("content_scan")
        })
        return _obj
