...
class DeliverResponseDelivery(BaseModel):
    """
    DeliverResponseDelivery
    """ # noqa: E501
    pool: Optional[StrictStr] = Field(default=None, description="IP pool used")
    lane: Optional[StrictStr] = Field(default=None, description="Delivery lane")
    warmup_limited: Optional[StrictBool] = Field(default=None, description="Whether warmup throttling was applied")
    __properties: ClassVar[List[str]] = ["pool", "lane", "warmup_limited"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pool": obj.get("pool"),
            "lane": obj.get("lane"),
            "warmup_limited": obj.get("warmup_limited")
        })
        return _obj
