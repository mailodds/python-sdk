...
class GetBlacklistHistory200Response(BaseModel):
    """
    GetBlacklistHistory200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    checks: Optional[List[GetBlacklistHistory200ResponseChecksInner]] = None
    pagination: Optional[Pagination] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "checks", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "checks": [GetBlacklistHistory200ResponseChecksInner.from_dict(_item) for _item in obj["checks"]] if obj.get("checks") is not None else None,
