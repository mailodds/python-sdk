...
class GetBounceRecords200Response(BaseModel):
    """
    ...
    records: Optional[List[GetBounceRecords200ResponseRecordsInner]] = None
    pagination: Optional[Pagination] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "records", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [GetBounceRecords200ResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
