...
class GetBounceRecords200ResponseRecordsInner(BaseModel):
    """
    ...
    smtp_code: Optional[StrictInt] = None
    enhanced_status: Optional[StrictStr] = None
    diagnostic: Optional[StrictStr] = None
    mx_host: Optional[StrictStr] = None
    bounced_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "email", "bounce_type", "smtp_code", "enhanced_status", "diagnostic", "mx_host", "bounced_at"]
