...
class GetCampaignABResults200Response(BaseModel):
    """
    ...
    variants: Optional[List[GetCampaignABResults200ResponseVariantsInner]] = None
    winner: Optional[GetCampaignABResults200ResponseWinner] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "campaign_id", "variants", "winner"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "variants": [GetCampaignABResults200ResponseVariantsInner.from_dict(_item) for _item in obj["variants"]] if obj.get("variants") is not None else None,
            "winner": GetCampaignABResults200ResponseWinner.from_dict(obj["winner"]) if obj.get("winner") is not None else None
        })
        return _obj
