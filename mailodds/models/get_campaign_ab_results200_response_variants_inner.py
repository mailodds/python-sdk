...
class GetCampaignABResults200ResponseVariantsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["variant_id", "name", "subject", "weight", "sent", "delivered", "opened", "clicked", "bounced", "open_rate", "click_rate"]
