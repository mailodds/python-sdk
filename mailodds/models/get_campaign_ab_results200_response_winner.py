...
class GetCampaignABResults200ResponseWinner(BaseModel):
    """
    Winning variant, or null if no statistical winner yet
    """ # noqa: E501
    variant_id: Optional[StrictStr] = None
    metric: Optional[StrictStr] = Field(default=None, description="Metric used to determine winner (open_rate or click_rate)")
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Statistical confidence level (0-1)")
    __properties: ClassVar[List[str]] = ["variant_id", "metric", "confidence"]
