...
class GetCampaignAttribution200Response(BaseModel):
    """
    ...
    attribution: Optional[GetCampaignAttribution200ResponseAttribution] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "campaign_id", "attribution"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attribution": GetCampaignAttribution200ResponseAttribution.from_dict(obj["attribution"]) if obj.get("attribution") is not None else None
        })
        return _obj
