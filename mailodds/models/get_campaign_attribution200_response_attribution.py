...
class GetCampaignAttribution200ResponseAttribution(BaseModel):
    """
    GetCampaignAttribution200ResponseAttribution
    """ # noqa: E501
    first_touch: Optional[GetCampaignAttribution200ResponseAttributionFirstTouch] = None
    last_touch: Optional[GetCampaignAttribution200ResponseAttributionFirstTouch] = None
    __properties: ClassVar[List[str]] = ["first_touch", "last_touch"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of first_touch
        if self.first_touch:
            _dict['first_touch'] = self.first_touch.to_dict()
        # override the default output from pydantic by calling `to_dict()` of last_touch
        if self.last_touch:
            _dict['last_touch'] = self.last_touch.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "first_touch": GetCampaignAttribution200ResponseAttributionFirstTouch.from_dict(obj["first_touch"]) if obj.get("first_touch") is not None else None,
            "last_touch": GetCampaignAttribution200ResponseAttributionFirstTouch.from_dict(obj["last_touch"]) if obj.get("last_touch") is not None else None
        })
        return _obj
