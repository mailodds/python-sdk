...
class GetCampaignDeliveryConfidence200Response(BaseModel):
    """
    ...
    confidence_score: Optional[StrictInt] = Field(default=None, description="Predicted delivery confidence (0-100)")
    factors: Optional[GetCampaignDeliveryConfidence200ResponseFactors] = None
    recommendations: Optional[List[StrictStr]] = Field(default=None, description="Actionable recommendations to improve delivery confidence")
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "campaign_id", "confidence_score", "factors", "recommendations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "factors": GetCampaignDeliveryConfidence200ResponseFactors.from_dict(obj["factors"]) if obj.get("factors") is not None else None,
