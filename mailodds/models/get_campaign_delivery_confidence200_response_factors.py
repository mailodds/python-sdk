...
class GetCampaignDeliveryConfidence200ResponseFactors(BaseModel):
    """
    GetCampaignDeliveryConfidence200ResponseFactors
    """ # noqa: E501
    list_quality: Optional[GetCampaignDeliveryConfidence200ResponseFactorsListQuality] = None
    sender_reputation: Optional[GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation] = None
    domain_auth: Optional[GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth] = None
    __properties: ClassVar[List[str]] = ["list_quality", "sender_reputation", "domain_auth"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of list_quality
        if self.list_quality:
            _dict['list_quality'] = self.list_quality.to_dict()
        # override the default output from pydantic by calling `to_dict()` of sender_reputation
        if self.sender_reputation:
            _dict['sender_reputation'] = self.sender_reputation.to_dict()
        # override the default output from pydantic by calling `to_dict()` of domain_auth
        if self.domain_auth:
            _dict['domain_auth'] = self.domain_auth.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list_quality": GetCampaignDeliveryConfidence200ResponseFactorsListQuality.from_dict(obj["list_quality"]) if obj.get("list_quality") is not None else None,
            "sender_reputation": GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation.from_dict(obj["sender_reputation"]) if obj.get("sender_reputation") is not None else None,
            "domain_auth": GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth.from_dict(obj["domain_auth"]) if obj.get("domain_auth") is not None else None
        })
        return _obj
