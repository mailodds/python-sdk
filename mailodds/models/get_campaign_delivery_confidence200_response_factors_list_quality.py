...
class GetCampaignDeliveryConfidence200ResponseFactorsListQuality(BaseModel):
    """
    GetCampaignDeliveryConfidence200ResponseFactorsListQuality
    """ # noqa: E501
    score: Optional[StrictInt] = None
    total_recipients: Optional[StrictInt] = None
    validated_pct: Optional[Union[StrictFloat, StrictInt]] = None
    suppressed_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["score", "total_recipients", "validated_pct", "suppressed_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "score": obj.get("score"),
            "total_recipients": obj.get("total_recipients"),
            "validated_pct": obj.get("validated_pct"),
