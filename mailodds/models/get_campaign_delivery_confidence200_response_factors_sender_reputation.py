...
class GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation(BaseModel):
    """
    GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation
    """ # noqa: E501
    score: Optional[StrictInt] = None
    recent_bounce_rate: Optional[Union[StrictFloat, StrictInt]] = None
    recent_complaint_rate: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["score", "recent_bounce_rate", "recent_complaint_rate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "score": obj.get("score"),
            "recent_bounce_rate": obj.get("recent_bounce_rate"),
            "recent_complaint_rate": obj.get("recent_complaint_rate")
        })
        return _obj
