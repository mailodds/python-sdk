...
class GetCampaignFunnel200Response(BaseModel):
    """
    ...
    funnel: Optional[GetCampaignFunnel200ResponseFunnel] = None
    rates: Optional[GetCampaignFunnel200ResponseRates] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "campaign_id", "funnel", "rates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "funnel": GetCampaignFunnel200ResponseFunnel.from_dict(obj["funnel"]) if obj.get("funnel") is not None else None,
            "rates": GetCampaignFunnel200ResponseRates.from_dict(obj["rates"]) if obj.get("rates") is not None else None
        })
        return _obj
