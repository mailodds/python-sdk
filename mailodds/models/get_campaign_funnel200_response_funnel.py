...
class GetCampaignFunnel200ResponseFunnel(BaseModel):
    """
    ...
    complained: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["sent", "delivered", "opened", "clicked", "unsubscribed", "bounced", "complained"]
