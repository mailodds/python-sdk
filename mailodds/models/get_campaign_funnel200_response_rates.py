...
class GetCampaignFunnel200ResponseRates(BaseModel):
    """
    ...
    click_to_open_rate: Optional[Union[StrictFloat, StrictInt]] = None
    bounce_rate: Optional[Union[StrictFloat, StrictInt]] = None
    unsubscribe_rate: Optional[Union[StrictFloat, StrictInt]] = None
    complaint_rate: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["delivery_rate", "open_rate", "click_rate", "click_to_open_rate", "bounce_rate", "unsubscribe_rate", "complaint_rate"]
