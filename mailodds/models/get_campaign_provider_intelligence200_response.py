...
class GetCampaignProviderIntelligence200Response(BaseModel):
    """
    ...
    providers: Optional[List[GetCampaignProviderIntelligence200ResponseProvidersInner]] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "campaign_id", "providers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "providers": [GetCampaignProviderIntelligence200ResponseProvidersInner.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
        return _obj
