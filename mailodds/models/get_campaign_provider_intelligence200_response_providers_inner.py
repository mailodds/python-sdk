...
class GetCampaignProviderIntelligence200ResponseProvidersInner(BaseModel):
    """
    GetCampaignProviderIntelligence200ResponseProvidersInner
    """ # noqa: E501
    provider: Optional[StrictStr] = Field(default=None, description="Provider name (e.g. gmail, outlook, yahoo)")
    ...
    __properties: ClassVar[List[str]] = ["provider", "sent", "delivered", "bounced", "opened", "clicked", "delivery_rate", "open_rate", "click_rate"]
