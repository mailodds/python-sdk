...
class GetComplaintAssessment200Response(BaseModel):
    """
    ...
    total_complaints: Optional[StrictInt] = None
    total_sent: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "complaint_rate", "risk_level", "total_complaints", "total_sent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total_complaints": obj.get("total_complaints"),
