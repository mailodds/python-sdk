...
class GetDisengagedContacts200Response(BaseModel):
    """
    ...
    pagination: Optional[GetDisengagedContacts200ResponsePagination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data"),
            "pagination": GetDisengagedContacts200ResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
