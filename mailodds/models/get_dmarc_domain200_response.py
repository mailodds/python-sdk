...
class GetDmarcDomain200Response(BaseModel):
    """
    GetDmarcDomain200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    domain: Optional[GetDmarcDomain200ResponseDomain] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "domain"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "domain": GetDmarcDomain200ResponseDomain.from_dict(obj["domain"]) if obj.get("domain") is not None else None
        })
        return _obj
