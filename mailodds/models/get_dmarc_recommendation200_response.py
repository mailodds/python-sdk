...
class GetDmarcRecommendation200Response(BaseModel):
    """
    GetDmarcRecommendation200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    recommendation: Optional[GetDmarcRecommendation200ResponseRecommendation] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "recommendation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recommendation": GetDmarcRecommendation200ResponseRecommendation.from_dict(obj["recommendation"]) if obj.get("recommendation") is not None else None
        })
        return _obj
