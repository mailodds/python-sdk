...
class GetDmarcRecommendation200ResponseRecommendation(BaseModel):
    """
    GetDmarcRecommendation200ResponseRecommendation
    """ # noqa: E501
    current_policy: Optional[StrictStr] = Field(default=None, description="Current DMARC policy (none, quarantine, reject)")
    recommended_policy: Optional[StrictStr] = Field(default=None, description="Recommended DMARC policy")
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Confidence level (0-1)")
    reasons: Optional[List[StrictStr]] = Field(default=None, description="Reasons for the recommendation")
    ready_to_upgrade: Optional[StrictBool] = Field(default=None, description="Whether it is safe to upgrade")
    __properties: ClassVar[List[str]] = ["current_policy", "recommended_policy", "confidence", "reasons", "ready_to_upgrade"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current_policy": obj.get("current_policy"),
            "recommended_policy": obj.get("recommended_policy"),
            "confidence": obj.get("confidence"),
            "reasons": obj.get("reasons"),
            "ready_to_upgrade": obj.get("ready_to_upgrade")
        })
        return _obj
