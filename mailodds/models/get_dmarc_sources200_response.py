...
class GetDmarcSources200Response(BaseModel):
    """
    GetDmarcSources200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    sources: Optional[List[GetDmarcSources200ResponseSourcesInner]] = None
    pagination: Optional[Pagination] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "sources", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sources": [GetDmarcSources200ResponseSourcesInner.from_dict(_item) for _item in obj["sources"]] if obj.get("sources") is not None else None,
