...
class GetDmarcSources200ResponseSourcesInner(BaseModel):
    """
    ...
    dkim_pass: Optional[StrictInt] = None
    dkim_fail: Optional[StrictInt] = None
    spf_pass: Optional[StrictInt] = None
    spf_fail: Optional[StrictInt] = None
    disposition: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["source_ip", "hostname", "org", "count", "dkim_pass", "dkim_fail", "spf_pass", "spf_fail", "disposition"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "org": obj.get("org"),
            "count": obj.get("count"),
            "dkim_pass": obj.get("dkim_pass"),
            "dkim_fail": obj.get("dkim_fail"),
            "spf_pass": obj.get("spf_pass"),
            "spf_fail": obj.get("spf_fail"),
