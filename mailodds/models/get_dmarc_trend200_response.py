...
class GetDmarcTrend200Response(BaseModel):
    """
    GetDmarcTrend200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    trend: Optional[List[GetDmarcTrend200ResponseTrendInner]] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "trend"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "trend": [GetDmarcTrend200ResponseTrendInner.from_dict(_item) for _item in obj["trend"]] if obj.get("trend") is not None else None
        })
        return _obj
