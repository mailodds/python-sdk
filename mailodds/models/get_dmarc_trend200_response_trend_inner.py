...
class GetDmarcTrend200ResponseTrendInner(BaseModel):
    """
    GetDmarcTrend200ResponseTrendInner
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, alias="date")
    var_pass: Optional[StrictInt] = Field(default=None, alias="pass")
    fail: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    pass_rate: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["date", "pass", "fail", "total", "pass_rate"]
