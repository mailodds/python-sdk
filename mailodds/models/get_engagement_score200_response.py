...
class GetEngagementScore200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "email", "score", "last_engaged_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if last_engaged_at (nullable) is None
        # and model_fields_set contains the field
        if self.last_engaged_at is None and "last_engaged_at" in self.model_fields_set:
            _dict['last_engaged_at'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "score": obj.get("score"),
            "last_engaged_at": obj.get("last_engaged_at")
        })
        return _obj
