...
class GetInactiveContactsReport200Response(BaseModel):
    """
    GetInactiveContactsReport200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    inactive_count: Optional[StrictInt] = None
    total_contacts: Optional[StrictInt] = None
    inactive_rate: Optional[Union[StrictFloat, StrictInt]] = None
    by_list: Optional[List[GetInactiveContactsReport200ResponseByListInner]] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "inactive_count", "total_contacts", "inactive_rate", "by_list"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in by_list (list)
        _items = []
        if self.by_list:
            for _item_by_list in self.by_list:
                if _item_by_list:
                    _items.append(_item_by_list.to_dict())
            _dict['by_list'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inactive_count": obj.get("inactive_count"),
            "total_contacts": obj.get("total_contacts"),
            "inactive_rate": obj.get("inactive_rate"),
            "by_list": [GetInactiveContactsReport200ResponseByListInner.from_dict(_item) for _item in obj["by_list"]] if obj.get("by_list") is not None else None
        })
        return _obj
