...
class GetInactiveContactsReport200ResponseByListInner(BaseModel):
    """
    GetInactiveContactsReport200ResponseByListInner
    """ # noqa: E501
    list_id: Optional[StrictStr] = None
    list_name: Optional[StrictStr] = None
    inactive_count: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["list_id", "list_name", "inactive_count", "total"]
