...
class GetLists200Response(BaseModel):
    ...
    GetLists200Response
    """ # noqa: E501
    lists: Optional[List[SubscriberList]] = None
    total: Optional[StrictInt] = None
    page: Optional[StrictInt] = None
    per_page: Optional[StrictInt] = None
    pages: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["lists", "total", "page", "per_page", "pages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lists": [SubscriberList.from_dict(_item) for _item in obj["lists"]] if obj.get("lists") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
