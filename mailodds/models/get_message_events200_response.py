...
class GetMessageEvents200Response(BaseModel):
    """
    ...
    summary: Optional[GetMessageEvents200ResponseSummary] = None
    clicks: Optional[List[GetMessageEvents200ResponseClicksInner]] = None
    events: Optional[List[GetMessageEvents200ResponseEventsInner]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "message_id", "recipient", "summary", "clicks", "events", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "summary": GetMessageEvents200ResponseSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
            "clicks": [GetMessageEvents200ResponseClicksInner.from_dict(_item) for _item in obj["clicks"]] if obj.get("clicks") is not None else None,
            "events": [GetMessageEvents200ResponseEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "total": obj.get("total")
        })
        return _obj
