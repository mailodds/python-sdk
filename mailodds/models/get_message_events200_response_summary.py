...
class GetMessageEvents200ResponseSummary(BaseModel):
    """
    GetMessageEvents200ResponseSummary
    """ # noqa: E501
    delivered: Optional[StrictBool] = None
    bounced: Optional[StrictBool] = None
    human_opens: Optional[StrictInt] = None
    bot_opens: Optional[StrictInt] = None
    clicks: Optional[StrictInt] = None
    unsubscribed: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["delivered", "bounced", "human_opens", "bot_opens", "clicks", "unsubscribed"]
