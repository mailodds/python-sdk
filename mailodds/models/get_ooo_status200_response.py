...
class GetOooStatus200Response(BaseModel):
    """
    GetOooStatus200Response
    """ # noqa: E501
    email: Optional[StrictStr] = None
    is_ooo: Optional[StrictBool] = None
    detected_at: Optional[datetime] = None
    expires_at: Optional[datetime] = None
    ooo_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["email", "is_ooo", "detected_at", "expires_at", "ooo_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if ooo_type (nullable) is None
        # and model_fields_set contains the field
        if self.ooo_type is None and "ooo_type" in self.model_fields_set:
            _dict['ooo_type'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "is_ooo": obj.get("is_ooo"),
            "detected_at": obj.get("detected_at"),
            "expires_at": obj.get("expires_at"),
            "ooo_type": obj.get("ooo_type")
        })
        return _obj
