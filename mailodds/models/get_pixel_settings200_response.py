...
class GetPixelSettings200Response(BaseModel):
    """
    GetPixelSettings200Response
    """ # noqa: E501
    pixel_uuid: Optional[StrictStr] = None
    pixel_subscribe_list_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["pixel_uuid", "pixel_subscribe_list_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pixel_uuid (nullable) is None
        # and model_fields_set contains the field
        if self.pixel_uuid is None and "pixel_uuid" in self.model_fields_set:
            _dict['pixel_uuid'] = None

        # set to None if pixel_subscribe_list_id (nullable) is None
        # and model_fields_set contains the field
        if self.pixel_subscribe_list_id is None and "pixel_subscribe_list_id" in self.model_fields_set:
            _dict['pixel_subscribe_list_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pixel_uuid": obj.get("pixel_uuid"),
            "pixel_subscribe_list_id": obj.get("pixel_subscribe_list_id")
        })
        return _obj
