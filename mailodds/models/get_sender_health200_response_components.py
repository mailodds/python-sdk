...
class GetSenderHealth200ResponseComponents(BaseModel):
    """
    GetSenderHealth200ResponseComponents
    """ # noqa: E501
    delivery_rate: Optional[GetSenderHealth200ResponseComponentsDeliveryRate] = None
    bounce_rate: Optional[GetSenderHealth200ResponseComponentsDeliveryRate] = None
    complaint_rate: Optional[GetSenderHealth200ResponseComponentsDeliveryRate] = None
    authentication: Optional[GetSenderHealth200ResponseComponentsDeliveryRate] = None
    __properties: ClassVar[List[str]] = ["delivery_rate", "bounce_rate", "complaint_rate", "authentication"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of delivery_rate
        if self.delivery_rate:
            _dict['delivery_rate'] = self.delivery_rate.to_dict()
        # override the default output from pydantic by calling `to_dict()` of bounce_rate
        if self.bounce_rate:
            _dict['bounce_rate'] = self.bounce_rate.to_dict()
        # override the default output from pydantic by calling `to_dict()` of complaint_rate
        if self.complaint_rate:
            _dict['complaint_rate'] = self.complaint_rate.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "delivery_rate": GetSenderHealth200ResponseComponentsDeliveryRate.from_dict(obj["delivery_rate"]) if obj.get("delivery_rate") is not None else None,
            "bounce_rate": GetSenderHealth200ResponseComponentsDeliveryRate.from_dict(obj["bounce_rate"]) if obj.get("bounce_rate") is not None else None,
            "complaint_rate": GetSenderHealth200ResponseComponentsDeliveryRate.from_dict(obj["complaint_rate"]) if obj.get("complaint_rate") is not None else None,
            "authentication": GetSenderHealth200ResponseComponentsDeliveryRate.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None
        })
        return _obj
