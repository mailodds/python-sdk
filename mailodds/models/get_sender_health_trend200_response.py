...
class GetSenderHealthTrend200Response(BaseModel):
    """
    ...
    data_points: Optional[List[GetSenderHealthTrend200ResponseDataPointsInner]] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "period", "data_points"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data_points": [GetSenderHealthTrend200ResponseDataPointsInner.from_dict(_item) for _item in obj["data_points"]] if obj.get("data_points") is not None else None
        })
        return _obj
