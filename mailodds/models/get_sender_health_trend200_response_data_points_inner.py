...
class GetSenderHealthTrend200ResponseDataPointsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["date", "score", "delivery_rate", "bounce_rate", "complaint_rate", "volume"]
