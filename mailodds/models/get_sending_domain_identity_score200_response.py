...
class GetSendingDomainIdentityScore200Response(BaseModel):
    """
    GetSendingDomainIdentityScore200Response
    """ # noqa: E501
    identity_score: Optional[SendingDomainIdentityScore] = None
    __properties: ClassVar[List[str]] = ["identity_score"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of identity_score
        if self.identity_score:
            _dict['identity_score'] = self.identity_score.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identity_score": SendingDomainIdentityScore.from_dict(obj["identity_score"]) if obj.get("identity_score") is not None else None
        })
        return _obj
