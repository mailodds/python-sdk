...
class GetSendingStats200Response(BaseModel):
    """
    GetSendingStats200Response
    """ # noqa: E501
    stats: Optional[GetSendingStats200ResponseStats] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stats": GetSendingStats200ResponseStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
        return _obj
