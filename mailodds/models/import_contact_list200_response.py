...
class ImportContactList200Response(BaseModel):
    """
    ...
    contact_list: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "imported", "skipped", "duplicates", "errors", "total", "contact_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "contact_list": obj.get("contact_list")
        })
        return _obj
