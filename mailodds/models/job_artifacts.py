...
class JobArtifacts(BaseModel):
    ...
    """ # noqa: E501
    csv_all: Optional[StrictStr] = Field(default=None, description="CSV with all results")
    csv_valid: Optional[StrictStr] = Field(default=None, description="CSV with valid emails only")
    csv_invalid: Optional[StrictStr] = Field(default=None, description="CSV with invalid emails only")
    __properties: ClassVar[List[str]] = ["csv_all", "csv_valid", "csv_invalid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "csv_all": obj.get("csv_all"),
            "csv_valid": obj.get("csv_valid"),
            "csv_invalid": obj.get("csv_invalid")
        })
        return _obj
