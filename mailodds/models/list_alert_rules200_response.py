...
class ListAlertRules200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "rules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": [AlertRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
