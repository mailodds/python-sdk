...
class ListBlacklistMonitors200Response(BaseModel):
    """
    ListBlacklistMonitors200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    monitors: Optional[List[BlacklistMonitor]] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "monitors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monitors": [BlacklistMonitor.from_dict(_item) for _item in obj["monitors"]] if obj.get("monitors") is not None else None
        })
        return _obj
