...
class ListContactLists200Response(BaseModel):
    """
    ListContactLists200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    contact_lists: Optional[List[ContactList]] = None
    total: Optional[StrictInt] = None
    page: Optional[StrictInt] = None
    per_page: Optional[StrictInt] = None
    pages: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "contact_lists", "total", "page", "per_page", "pages"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in contact_lists (list)
        _items = []
        if self.contact_lists:
            for _item_contact_lists in self.contact_lists:
                if _item_contact_lists:
                    _items.append(_item_contact_lists.to_dict())
            _dict['contact_lists'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact_lists": [ContactList.from_dict(_item) for _item in obj["contact_lists"]] if obj.get("contact_lists") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
