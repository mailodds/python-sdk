...
class ListDmarcDomains200Response(BaseModel):
    """
    ListDmarcDomains200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    domains: Optional[List[DmarcDomain]] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "domains"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "domains": [DmarcDomain.from_dict(_item) for _item in obj["domains"]] if obj.get("domains") is not None else None
        })
        return _obj
