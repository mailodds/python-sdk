...
class ListSendingDomains200Response(BaseModel):
    """
    ListSendingDomains200Response
    """ # noqa: E501
    domains: Optional[List[SendingDomain]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "domains": [SendingDomain.from_dict(_item) for _item in obj["domains"]] if obj.get("domains") is not None else None
        })
        return _obj
