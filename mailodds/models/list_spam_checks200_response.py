...
class ListSpamChecks200Response(BaseModel):
    """
    ListSpamChecks200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    spam_checks: Optional[List[SpamCheck]] = None
    pagination: Optional[Pagination] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "spam_checks", "pagination"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in spam_checks (list)
        _items = []
        if self.spam_checks:
            for _item_spam_checks in self.spam_checks:
                if _item_spam_checks:
                    _items.append(_item_spam_checks.to_dict())
            _dict['spam_checks'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spam_checks": [SpamCheck.from_dict(_item) for _item in obj["spam_checks"]] if obj.get("spam_checks") is not None else None,
