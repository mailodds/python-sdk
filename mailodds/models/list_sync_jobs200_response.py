...
class ListSyncJobs200Response(BaseModel):
    """
    ListSyncJobs200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    sync_jobs: Optional[List[Dict[str, Any]]] = None
    total: Optional[StrictInt] = None
    page: Optional[StrictInt] = None
    per_page: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "sync_jobs", "total", "page", "per_page"]
