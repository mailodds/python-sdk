...
class McpCapabilitiesPillarsInner(BaseModel):
    """
    McpCapabilitiesPillarsInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    tool_count: Optional[StrictInt] = None
    tools: Optional[List[McpCapabilitiesPillarsInnerToolsInner]] = None
    __properties: ClassVar[List[str]] = ["name", "tool_count", "tools"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tools": [McpCapabilitiesPillarsInnerToolsInner.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None
        })
        return _obj
