...
class McpCapabilitiesPillarsInnerToolsInner(BaseModel):
    """
    McpCapabilitiesPillarsInnerToolsInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    required_scope: Optional[StrictStr] = Field(default=None, description="OAuth scope required to use this tool")
    __properties: ClassVar[List[str]] = ["name", "required_scope"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of McpCapabilitiesPillarsInnerToolsInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if required_scope (nullable) is None
        # and model_fields_set contains the field
        if self.required_scope is None and "required_scope" in self.model_fields_set:
            _dict['required_scope'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of McpCapabilitiesPillarsInnerToolsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "required_scope": obj.get("required_scope")
        })
        return _obj
