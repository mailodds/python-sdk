...
class PolicyRuleAction(BaseModel):
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['accept', 'reject', 'accept_with_caution', 'do_not_mail', 'review']):
            raise ValueError("must be one of enum values ('accept', 'reject', 'accept_with_caution', 'do_not_mail', 'review')")
        return value
