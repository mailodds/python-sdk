...
class ProductFacets(BaseModel):
    ...
    """ # noqa: E501
    categories: Optional[List[ProductFacetsCategoriesInner]] = None
    price_ranges: Optional[List[ProductFacetsPriceRangesInner]] = None
    stores: Optional[List[ProductFacetsStoresInner]] = None
    __properties: ClassVar[List[str]] = ["categories", "price_ranges", "stores"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [ProductFacetsCategoriesInner.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
            "price_ranges": [ProductFacetsPriceRangesInner.from_dict(_item) for _item in obj["price_ranges"]] if obj.get("price_ranges") is not None else None,
            "stores": [ProductFacetsStoresInner.from_dict(_item) for _item in obj["stores"]] if obj.get("stores") is not None else None
        })
        return _obj
