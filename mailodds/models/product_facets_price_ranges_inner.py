...
class ProductFacetsPriceRangesInner(BaseModel):
    """
    ProductFacetsPriceRangesInner
    """ # noqa: E501
    range: Optional[StrictStr] = Field(default=None, description="Price range label (e.g., '0-10', '500+')")
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["range", "count"]
