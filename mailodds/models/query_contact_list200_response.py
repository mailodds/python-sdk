...
class QueryContactList200Response(BaseModel):
    """
    QueryContactList200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    emails: Optional[List[QueryContactList200ResponseEmailsInner]] = None
    total: Optional[StrictInt] = None
    page: Optional[StrictInt] = None
    per_page: Optional[StrictInt] = None
    pages: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "emails", "total", "page", "per_page", "pages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "emails": [QueryContactList200ResponseEmailsInner.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
