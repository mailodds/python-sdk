...
class QueryContactListRequest(BaseModel):
    """
    QueryContactListRequest
    """ # noqa: E501
    filters: Optional[List[QueryContactListRequestFiltersInner]] = Field(default=None, description="Array of filter conditions")
    page: Optional[StrictInt] = 1
    per_page: Optional[Annotated[int, Field(le=500, strict=True)]] = 100
    __properties: ClassVar[List[str]] = ["filters", "page", "per_page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [QueryContactListRequestFiltersInner.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None,
            "page": obj.get("page") if obj.get("page") is not None else 1,
            "per_page": obj.get("per_page") if obj.get("per_page") is not None else 100
        })
        return _obj
