...
class QueryContactListRequestFiltersInner(BaseModel):
    """
    QueryContactListRequestFiltersInner
    """ # noqa: E501
    var_field: Optional[StrictStr] = Field(default=None, description="Field to filter on", alias="field")
    ...
    def operator_validate_enum(cls, value):
        ...
        if value not in set(['eq', 'neq', 'contains', 'in']):
            raise ValueError("must be one of enum values ('eq', 'neq', 'contains', 'in')")
        return value
