...
class RetryJob200Response(BaseModel):
    """
    RetryJob200Response
    """ # noqa: E501
    ...
    pending_count: Optional[StrictInt] = Field(default=None, description="Number of emails re-queued")
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "job", "pending_count"]
