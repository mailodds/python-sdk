...
class RunBlacklistCheck200Response(BaseModel):
    """
    RunBlacklistCheck200Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    monitor: Optional[BlacklistMonitor] = None
    check: Optional[RunBlacklistCheck200ResponseCheck] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "monitor", "check"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monitor": BlacklistMonitor.from_dict(obj["monitor"]) if obj.get("monitor") is not None else None,
            "check": RunBlacklistCheck200ResponseCheck.from_dict(obj["check"]) if obj.get("check") is not None else None
        })
        return _obj
