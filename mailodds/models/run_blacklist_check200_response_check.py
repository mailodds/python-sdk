...
class RunBlacklistCheck200ResponseCheck(BaseModel):
    """
    RunBlacklistCheck200ResponseCheck
    """ # noqa: E501
    id: Optional[StrictStr] = None
    listed_on: Optional[List[StrictStr]] = Field(default=None, description="Blacklists where the target is listed")
    clean_on: Optional[List[StrictStr]] = Field(default=None, description="Blacklists where the target is clean")
    checked_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "listed_on", "clean_on", "checked_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "listed_on": obj.get("listed_on"),
            "clean_on": obj.get("clean_on"),
