...
class RunServerTest201Response(BaseModel):
    """
    RunServerTest201Response
    """ # noqa: E501
    schema_version: Optional[StrictStr] = None
    request_id: Optional[StrictStr] = None
    test: Optional[ServerTest] = None
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "test"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "test": ServerTest.from_dict(obj["test"]) if obj.get("test") is not None else None
        })
        return _obj
