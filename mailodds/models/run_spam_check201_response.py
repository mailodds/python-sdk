...
class RunSpamCheck201Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "spam_check"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of spam_check
        if self.spam_check:
            _dict['spam_check'] = self.spam_check.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spam_check": SpamCheck.from_dict(obj["spam_check"]) if obj.get("spam_check") is not None else None
        })
        return _obj
