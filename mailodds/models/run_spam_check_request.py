...
class RunSpamCheckRequest(BaseModel):
    """
    RunSpamCheckRequest
    """ # noqa: E501
    from_domain: StrictStr = Field(description="Sending domain to check")
    links: Optional[List[StrictStr]] = Field(default=None, description="URLs included in the email")
    subject_preview: Optional[StrictStr] = Field(default=None, description="Email subject line to analyze")
    client_scores: Optional[Dict[str, Any]] = Field(default=None, description="Client-side spam scores to include in analysis")
    __properties: ClassVar[List[str]] = ["from_domain", "links", "subject_preview", "client_scores"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": obj.get("links"),
            "subject_preview": obj.get("subject_preview"),
            "client_scores": obj.get("client_scores")
        })
        return _obj
