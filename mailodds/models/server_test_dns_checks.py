...
class ServerTestDnsChecks(BaseModel):
    """
    ServerTestDnsChecks
    """ # noqa: E501
    spf: Optional[StrictBool] = None
    dkim: Optional[StrictBool] = None
    dmarc: Optional[StrictBool] = None
    dmarc_policy: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["spf", "dkim", "dmarc", "dmarc_policy"]
