...
class SpamCheckChecks(BaseModel):
    """
    Individual check results
    """ # noqa: E501
    domain_reputation: Optional[Dict[str, Any]] = None
    link_safety: Optional[Dict[str, Any]] = None
    subject_analysis: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["domain_reputation", "link_safety", "subject_analysis"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "domain_reputation": obj.get("domain_reputation"),
            "link_safety": obj.get("link_safety"),
            "subject_analysis": obj.get("subject_analysis")
        })
        return _obj
