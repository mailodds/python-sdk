...
class StoreConnection(BaseModel):
    ...
    StoreConnection
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Store connection UUID")
    account_id: Optional[StrictInt] = None
    platform: Optional[StrictStr] = Field(default=None, description="E-commerce platform")
    store_name: Optional[StrictStr] = None
    store_url: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    auth_method: Optional[StrictStr] = None
    product_count: Optional[StrictInt] = Field(default=None, description="Number of active products")
    last_synced_at: Optional[datetime] = None
    last_error: Optional[StrictStr] = Field(default=None, description="Last sync error message")
    sync_interval_seconds: Optional[StrictInt] = Field(default=3600, description="Auto-sync interval in seconds")
    settings: Optional[Dict[str, Any]] = Field(default=None, description="Platform-specific settings")
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "account_id", "platform", "store_name", "store_url", "status", "auth_method", "product_count", "last_synced_at", "last_error", "sync_interval_seconds", "settings", "created_at", "updated_at"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['pending', 'connected', 'active', 'syncing', 'error', 'disconnected']):
            raise ValueError("must be one of enum values ('pending', 'connected', 'active', 'syncing', 'error', 'disconnected')")
        return value
    ...
    def auth_method_validate_enum(cls, value):
        ...
        if value not in set(['plugin_handshake', 'api_key', 'oauth', 'feed_url']):
            raise ValueError("must be one of enum values ('plugin_handshake', 'api_key', 'oauth', 'feed_url')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sync_interval_seconds": obj.get("sync_interval_seconds") if obj.get("sync_interval_seconds") is not None else 3600,
