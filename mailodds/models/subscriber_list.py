...
class SubscriberList(BaseModel):
    ...
    SubscriberList
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="List UUID")
    ...
    description: Optional[StrictStr] = Field(default=None, description="List description")
    confirmation_redirect_url: Optional[StrictStr] = Field(default=None, description="Redirect URL after confirmation")
    confirmation_subject: Optional[StrictStr] = Field(default=None, description="Confirmation email subject")
    confirmation_from_name: Optional[StrictStr] = Field(default=None, description="Confirmation email sender name")
    subscriber_count: Optional[StrictInt] = Field(default=None, description="Total subscriber count")
    confirmed_count: Optional[StrictInt] = Field(default=None, description="Confirmed subscriber count")
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "account_id", "name", "description", "confirmation_redirect_url", "confirmation_subject", "confirmation_from_name", "subscriber_count", "confirmed_count", "created_at", "updated_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if confirmation_redirect_url (nullable) is None
        # and model_fields_set contains the field
        if self.confirmation_redirect_url is None and "confirmation_redirect_url" in self.model_fields_set:
            _dict['confirmation_redirect_url'] = None

        # set to None if confirmation_subject (nullable) is None
        # and model_fields_set contains the field
        if self.confirmation_subject is None and "confirmation_subject" in self.model_fields_set:
            _dict['confirmation_subject'] = None

        # set to None if confirmation_from_name (nullable) is None
        # and model_fields_set contains the field
        if self.confirmation_from_name is None and "confirmation_from_name" in self.model_fields_set:
            _dict['confirmation_from_name'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "confirmation_redirect_url": obj.get("confirmation_redirect_url"),
            "confirmation_subject": obj.get("confirmation_subject"),
            "confirmation_from_name": obj.get("confirmation_from_name"),
            "subscriber_count": obj.get("subscriber_count"),
            "confirmed_count": obj.get("confirmed_count"),
