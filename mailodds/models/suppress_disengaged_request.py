...
class SuppressDisengagedRequest(BaseModel):
    """
    SuppressDisengagedRequest
    """ # noqa: E501
    inactive_days: Optional[Annotated[int, Field(le=365, strict=True, ge=1)]] = Field(default=180, description="Days of inactivity threshold")
    min_sends: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(default=10, description="Minimum sends to qualify")
    dry_run: Optional[StrictBool] = Field(default=True, description="Preview without suppressing")
    __properties: ClassVar[List[str]] = ["inactive_days", "min_sends", "dry_run"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inactive_days": obj.get("inactive_days") if obj.get("inactive_days") is not None else 180,
            "min_sends": obj.get("min_sends") if obj.get("min_sends") is not None else 10,
