...
class SuppressionAuditResponse(BaseModel):
    ...
    entries: Optional[List[SuppressionAuditResponseEntriesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [SuppressionAuditResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
