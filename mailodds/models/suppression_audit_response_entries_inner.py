...
class SuppressionAuditResponseEntriesInner(BaseModel):
    """
    SuppressionAuditResponseEntriesInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    event_type: Optional[StrictStr] = Field(default=None, description="Audit event type")
    ...
    __properties: ClassVar[List[str]] = ["id", "event_type", "event_category", "details", "created_at"]
