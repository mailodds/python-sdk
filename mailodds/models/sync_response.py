...
class SyncResponse(BaseModel):
    ...
    idempotent: Optional[StrictBool] = Field(default=None, description="True if this was a duplicate request matched by Idempotency-Key")
    existing_job_id: Optional[StrictStr] = Field(default=None, description="ID of existing sync job if one was already running")
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "scheduled", "store_id", "idempotent", "existing_job_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "existing_job_id": obj.get("existing_job_id")
        })
        return _obj
