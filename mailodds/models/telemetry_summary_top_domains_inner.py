...
class TelemetrySummaryTopDomainsInner(BaseModel):
    """
    TelemetrySummaryTopDomainsInner
    """ # noqa: E501
    domain: Optional[StrictStr] = None
    volume: Optional[StrictInt] = None
    deliverable: Optional[Union[StrictFloat, StrictInt]] = None
    reject: Optional[Union[StrictFloat, StrictInt]] = None
    unknown: Optional[Union[StrictFloat, StrictInt]] = None
    catch_all: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="catchAll")
    __properties: ClassVar[List[str]] = ["domain", "volume", "deliverable", "reject", "unknown", "catchAll"]
