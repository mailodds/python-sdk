...
class TrackEventResponse(BaseModel):
    ...
    created: Optional[StrictBool] = Field(default=None, description="True if newly created, false if idempotent duplicate")
    idempotent: Optional[StrictBool] = Field(default=None, description="Present and true when returning an existing event")
    __properties: ClassVar[List[str]] = ["schema_version", "request_id", "event_id", "created", "idempotent"]
