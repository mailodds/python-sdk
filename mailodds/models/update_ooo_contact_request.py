...
class UpdateOooContactRequest(BaseModel):
    """
    UpdateOooContactRequest
    """ # noqa: E501
    is_active: Optional[StrictBool] = Field(default=None, description="Set to false to clear OOO status")
    ooo_type: Optional[StrictStr] = 'out_of_office'
    duration_days: Optional[Annotated[int, Field(le=365, strict=True, ge=1)]] = 7
    __properties: ClassVar[List[str]] = ["is_active", "ooo_type", "duration_days"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ooo_type": obj.get("ooo_type") if obj.get("ooo_type") is not None else 'out_of_office',
