...
class UpdatePixelSettingsRequest(BaseModel):
    """
    UpdatePixelSettingsRequest
    """ # noqa: E501
    pixel_subscribe_list_id: Optional[StrictInt] = Field(description="Contact list ID for pixel subscriptions, or null to disable")
    __properties: ClassVar[List[str]] = ["pixel_subscribe_list_id"]
