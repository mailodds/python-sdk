...
class UpdateReplyForwardingRequest(BaseModel):
    """
    UpdateReplyForwardingRequest
    """ # noqa: E501
    forward_replies_to: Optional[StrictStr] = Field(default=None, description="Email to forward replies to, or null to disable")
    __properties: ClassVar[List[str]] = ["forward_replies_to"]
