...
class UpdateStoreRequest(BaseModel):
    ...
    UpdateStoreRequest
    """ # noqa: E501
    store_name: Optional[StrictStr] = Field(default=None, description="Display name for the store")
    sync_interval_seconds: Optional[Annotated[int, Field(strict=True, ge=1800)]] = Field(default=None, description="Auto-sync interval in seconds (min 1800)")
    settings: Optional[Dict[str, Any]] = Field(default=None, description="Platform-specific settings")
    credentials: Optional[Dict[str, Any]] = Field(default=None, description="Updated store credentials (connection is tested before saving)")
    __properties: ClassVar[List[str]] = ["store_name", "sync_interval_seconds", "settings", "credentials"]
