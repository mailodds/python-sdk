...
class TestAddBlacklistMonitorRequest(unittest.TestCase):
    """AddBlacklistMonitorRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddBlacklistMonitorRequest:
        """Test AddBlacklistMonitorRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddBlacklistMonitorRequest`
        """
        model = AddBlacklistMonitorRequest()
        if include_optional:
    ...
    def testAddBlacklistMonitorRequest(self):
        """Test AddBlacklistMonitorRequest"""
