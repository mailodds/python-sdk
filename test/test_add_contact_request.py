...
class TestAddContactRequest(unittest.TestCase):
    """AddContactRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddContactRequest:
        """Test AddContactRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddContactRequest`
        """
    ...
    def testAddContactRequest(self):
        """Test AddContactRequest"""
