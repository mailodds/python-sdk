...
class TestAddDmarcDomain201Response(unittest.TestCase):
    """AddDmarcDomain201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddDmarcDomain201Response:
        """Test AddDmarcDomain201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDmarcDomain201Response`
        """
        model = AddDmarcDomain201Response()
        if include_optional:
            return AddDmarcDomain201Response(
                schema_version = '',
                request_id = '',
                domain = mailodds.models.dmarc_domain.DmarcDomain(
                    id = '', 
                    domain = '', 
                    reporting_address = '', 
                    dns_verified = True, 
    ...
    def testAddDmarcDomain201Response(self):
        """Test AddDmarcDomain201Response"""
