...
class TestAddDmarcDomainRequest(unittest.TestCase):
    """AddDmarcDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddDmarcDomainRequest:
        """Test AddDmarcDomainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDmarcDomainRequest`
        """
        model = AddDmarcDomainRequest()
        if include_optional:
    ...
    def testAddDmarcDomainRequest(self):
        """Test AddDmarcDomainRequest"""
