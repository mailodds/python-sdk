...
class TestAgentControlPlaneApi(unittest.TestCase):
    """AgentControlPlaneApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AgentControlPlaneApi()

    def tearDown(self) -> None:
        pass

    def test_get_mcp_capabilities(self) -> None:
        """Test case for get_mcp_capabilities
