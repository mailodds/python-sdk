...
class TestAppendToContactList200Response(unittest.TestCase):
    """AppendToContactList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendToContactList200Response:
        """Test AppendToContactList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendToContactList200Response`
        """
        model = AppendToContactList200Response()
        if include_optional:
            return AppendToContactList200Response(
                schema_version = '',
                request_id = '',
                contact_list = mailodds.models.contact_list.ContactList(
                    id = '', 
                    name = '', 
                    email_count = 56, 
                    tags = [
    ...
    def testAppendToContactList200Response(self):
        """Test AppendToContactList200Response"""
