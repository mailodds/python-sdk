...
class TestAppendToContactListRequest(unittest.TestCase):
    """AppendToContactListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendToContactListRequest:
        """Test AppendToContactListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendToContactListRequest`
        """
        model = AppendToContactListRequest()
        if include_optional:
    ...
    def testAppendToContactListRequest(self):
        """Test AppendToContactListRequest"""
