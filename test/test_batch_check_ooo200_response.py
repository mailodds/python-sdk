...
class TestBatchCheckOoo200Response(unittest.TestCase):
    """BatchCheckOoo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCheckOoo200Response:
        """Test BatchCheckOoo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCheckOoo200Response`
        """
        model = BatchCheckOoo200Response()
        if include_optional:
            return BatchCheckOoo200Response(
                results = [
                    mailodds.models.batch_check_ooo_200_response_results_inner.batchCheckOoo_200_response_results_inner(
                        email = '', 
                        is_ooo = True, 
    ...
    def testBatchCheckOoo200Response(self):
        """Test BatchCheckOoo200Response"""
