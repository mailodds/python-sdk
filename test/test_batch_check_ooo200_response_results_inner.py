...
class TestBatchCheckOoo200ResponseResultsInner(unittest.TestCase):
    """BatchCheckOoo200ResponseResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCheckOoo200ResponseResultsInner:
        """Test BatchCheckOoo200ResponseResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCheckOoo200ResponseResultsInner`
        """
        model = BatchCheckOoo200ResponseResultsInner()
        if include_optional:
    ...
    def testBatchCheckOoo200ResponseResultsInner(self):
        """Test BatchCheckOoo200ResponseResultsInner"""
