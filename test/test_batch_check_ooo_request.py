...
class TestBatchCheckOooRequest(unittest.TestCase):
    """BatchCheckOooRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCheckOooRequest:
        """Test BatchCheckOooRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCheckOooRequest`
        """
        model = BatchCheckOooRequest()
        if include_optional:
    ...
    def testBatchCheckOooRequest(self):
        """Test BatchCheckOooRequest"""
