...
class TestBatchDeliverRequestStructuredData(unittest.TestCase):
    """BatchDeliverRequestStructuredData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchDeliverRequestStructuredData:
        """Test BatchDeliverRequestStructuredData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchDeliverRequestStructuredData`
        """
        model = BatchDeliverRequestStructuredData()
        if include_optional:
    ...
    def testBatchDeliverRequestStructuredData(self):
        """Test BatchDeliverRequestStructuredData"""
