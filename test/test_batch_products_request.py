...
class TestBatchProductsRequest(unittest.TestCase):
    """BatchProductsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchProductsRequest:
        """Test BatchProductsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchProductsRequest`
        """
        model = BatchProductsRequest()
        if include_optional:
            return BatchProductsRequest(
                products = [
                    mailodds.models.batch_products_request_products_inner.BatchProductsRequest_products_inner(
                        external_id = '', 
                        title = '', 
                        product_url = '', 
                        sku = '', 
    ...
    def testBatchProductsRequest(self):
        """Test BatchProductsRequest"""
