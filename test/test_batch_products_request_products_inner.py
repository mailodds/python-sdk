...
class TestBatchProductsRequestProductsInner(unittest.TestCase):
    """BatchProductsRequestProductsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchProductsRequestProductsInner:
        """Test BatchProductsRequestProductsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchProductsRequestProductsInner`
        """
        model = BatchProductsRequestProductsInner()
        if include_optional:
    ...
    def testBatchProductsRequestProductsInner(self):
        """Test BatchProductsRequestProductsInner"""
