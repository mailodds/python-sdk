...
class TestBatchProductsResponse(unittest.TestCase):
    """BatchProductsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchProductsResponse:
        """Test BatchProductsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchProductsResponse`
        """
        model = BatchProductsResponse()
        if include_optional:
            return BatchProductsResponse(
                ...
                errored = 56,
                errors = [
                    mailodds.models.batch_products_response_errors_inner.BatchProductsResponse_errors_inner(
                        external_id = '', 
                        error = '', )
                    ]
            )
    ...
    def testBatchProductsResponse(self):
        """Test BatchProductsResponse"""
