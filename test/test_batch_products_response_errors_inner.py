...
class TestBatchProductsResponseErrorsInner(unittest.TestCase):
    """BatchProductsResponseErrorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchProductsResponseErrorsInner:
        """Test BatchProductsResponseErrorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchProductsResponseErrorsInner`
        """
        model = BatchProductsResponseErrorsInner()
        if include_optional:
    ...
    def testBatchProductsResponseErrorsInner(self):
        """Test BatchProductsResponseErrorsInner"""
