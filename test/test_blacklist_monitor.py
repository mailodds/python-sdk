...
class TestBlacklistMonitor(unittest.TestCase):
    """BlacklistMonitor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlacklistMonitor:
        """Test BlacklistMonitor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlacklistMonitor`
        """
        model = BlacklistMonitor()
        if include_optional:
