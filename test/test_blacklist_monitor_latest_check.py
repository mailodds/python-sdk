...
class TestBlacklistMonitorLatestCheck(unittest.TestCase):
    """BlacklistMonitorLatestCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlacklistMonitorLatestCheck:
        """Test BlacklistMonitorLatestCheck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlacklistMonitorLatestCheck`
        """
        model = BlacklistMonitorLatestCheck()
        if include_optional:
    ...
    def testBlacklistMonitorLatestCheck(self):
        """Test BlacklistMonitorLatestCheck"""
