...
class TestBlacklistMonitoringApi(unittest.TestCase):
    """BlacklistMonitoringApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BlacklistMonitoringApi()

    def tearDown(self) -> None:
        pass

    def test_add_blacklist_monitor(self) -> None:
        """Test case for add_blacklist_monitor
    ...
    def test_list_blacklist_monitors(self) -> None:
        """Test case for list_blacklist_monitors

        List blacklist monitors
        """
        pass

    def test_run_blacklist_check(self) -> None:
        """Test case for run_blacklist_check
