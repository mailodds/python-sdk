...
class TestBounceAnalysisResponseAnalysis(unittest.TestCase):
    """BounceAnalysisResponseAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BounceAnalysisResponseAnalysis:
        """Test BounceAnalysisResponseAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BounceAnalysisResponseAnalysis`
        """
        model = BounceAnalysisResponseAnalysis()
        if include_optional:
    ...
    def testBounceAnalysisResponseAnalysis(self):
        """Test BounceAnalysisResponseAnalysis"""
