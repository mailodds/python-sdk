...
class TestBounceAnalysisResponseAnalysisCategories(unittest.TestCase):
    """BounceAnalysisResponseAnalysisCategories unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BounceAnalysisResponseAnalysisCategories:
        """Test BounceAnalysisResponseAnalysisCategories
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BounceAnalysisResponseAnalysisCategories`
        """
        model = BounceAnalysisResponseAnalysisCategories()
        if include_optional:
    ...
    def testBounceAnalysisResponseAnalysisCategories(self):
        """Test BounceAnalysisResponseAnalysisCategories"""
