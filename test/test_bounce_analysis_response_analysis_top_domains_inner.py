...
class TestBounceAnalysisResponseAnalysisTopDomainsInner(unittest.TestCase):
    """BounceAnalysisResponseAnalysisTopDomainsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BounceAnalysisResponseAnalysisTopDomainsInner:
        """Test BounceAnalysisResponseAnalysisTopDomainsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BounceAnalysisResponseAnalysisTopDomainsInner`
        """
        model = BounceAnalysisResponseAnalysisTopDomainsInner()
        if include_optional:
    ...
    def testBounceAnalysisResponseAnalysisTopDomainsInner(self):
        """Test BounceAnalysisResponseAnalysisTopDomainsInner"""
