...
class TestBulkUpdateProductsRequest(unittest.TestCase):
    """BulkUpdateProductsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkUpdateProductsRequest:
        """Test BulkUpdateProductsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkUpdateProductsRequest`
        """
        model = BulkUpdateProductsRequest()
        if include_optional:
    ...
    def testBulkUpdateProductsRequest(self):
        """Test BulkUpdateProductsRequest"""
