...
class TestClassifyContentRequest(unittest.TestCase):
    """ClassifyContentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClassifyContentRequest:
        """Test ClassifyContentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClassifyContentRequest`
        """
        model = ClassifyContentRequest()
        if include_optional:
    ...
    def testClassifyContentRequest(self):
        """Test ClassifyContentRequest"""
