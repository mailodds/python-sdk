...
class TestContactListsApi(unittest.TestCase):
    ...
    def test_create_contact_list(self) -> None:
    ...
    def test_list_contact_lists(self) -> None:
        """Test case for list_contact_lists

        List contact lists
        """
        pass

    def test_query_contact_list(self) -> None:
