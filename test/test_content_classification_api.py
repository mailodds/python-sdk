...
class TestContentClassificationApi(unittest.TestCase):
    """ContentClassificationApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ContentClassificationApi()

    def tearDown(self) -> None:
        pass

    def test_classify_content(self) -> None:
        """Test case for classify_content
