...
class TestCorrectInboundMessageRequest(unittest.TestCase):
    """CorrectInboundMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorrectInboundMessageRequest:
        """Test CorrectInboundMessageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorrectInboundMessageRequest`
        """
        model = CorrectInboundMessageRequest()
        if include_optional:
    ...
    def testCorrectInboundMessageRequest(self):
        """Test CorrectInboundMessageRequest"""
