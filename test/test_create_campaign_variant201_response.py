...
class TestCreateCampaignVariant201Response(unittest.TestCase):
    """CreateCampaignVariant201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCampaignVariant201Response:
        """Test CreateCampaignVariant201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCampaignVariant201Response`
        """
        model = CreateCampaignVariant201Response()
        if include_optional:
            return CreateCampaignVariant201Response(
                schema_version = '',
                request_id = '',
                variant = mailodds.models.campaign_variant.CampaignVariant(
                    id = '', 
                    campaign_id = '', 
                    name = '', 
                    subject = '', 
    ...
    def testCreateCampaignVariant201Response(self):
        """Test CreateCampaignVariant201Response"""
