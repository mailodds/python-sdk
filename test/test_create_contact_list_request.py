...
class TestCreateContactListRequest(unittest.TestCase):
    """CreateContactListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateContactListRequest:
        ...
        """
        model = CreateContactListRequest()
        if include_optional:
    ...
    def testCreateContactListRequest(self):
        """Test CreateContactListRequest"""
