...
class TestCreateListRequest(unittest.TestCase):
    """CreateListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateListRequest:
        """Test CreateListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateListRequest`
        """
    ...
    def testCreateListRequest(self):
        """Test CreateListRequest"""
