...
class TestCreateSendingDomainRequest(unittest.TestCase):
    """CreateSendingDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSendingDomainRequest:
        """Test CreateSendingDomainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSendingDomainRequest`
        """
        model = CreateSendingDomainRequest()
        if include_optional:
    ...
    def testCreateSendingDomainRequest(self):
        """Test CreateSendingDomainRequest"""
