...
class TestCreateStore201Response(unittest.TestCase):
    """CreateStore201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateStore201Response:
        """Test CreateStore201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateStore201Response`
        """
        model = CreateStore201Response()
        if include_optional:
            return CreateStore201Response(
                schema_version = '',
                request_id = '',
                store = mailodds.models.store_connection.StoreConnection(
                    id = '', 
                    account_id = 56, 
                    ...
                    store_url = '', 
                    status = 'pending', 
                    auth_method = 'plugin_handshake', 
                    product_count = 56, 
                    last_synced_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    last_error = '', 
                    sync_interval_seconds = 56, 
                    settings = mailodds.models.settings.settings(), 
    ...
    def testCreateStore201Response(self):
        """Test CreateStore201Response"""
