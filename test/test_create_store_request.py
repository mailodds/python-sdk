...
class TestCreateStoreRequest(unittest.TestCase):
    """CreateStoreRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateStoreRequest:
        """Test CreateStoreRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateStoreRequest`
        """
    ...
    def testCreateStoreRequest(self):
        """Test CreateStoreRequest"""
