...
class TestCreateWebhookCliSessionRequest(unittest.TestCase):
    """CreateWebhookCliSessionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateWebhookCliSessionRequest:
        """Test CreateWebhookCliSessionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateWebhookCliSessionRequest`
        """
        model = CreateWebhookCliSessionRequest()
        if include_optional:
    ...
    def testCreateWebhookCliSessionRequest(self):
        """Test CreateWebhookCliSessionRequest"""
