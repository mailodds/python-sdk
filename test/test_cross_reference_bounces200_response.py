...
class TestCrossReferenceBounces200Response(unittest.TestCase):
    """CrossReferenceBounces200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CrossReferenceBounces200Response:
        """Test CrossReferenceBounces200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CrossReferenceBounces200Response`
        """
        model = CrossReferenceBounces200Response()
        if include_optional:
            return CrossReferenceBounces200Response(
                schema_version = '',
                request_id = '',
                cross_reference = mailodds.models.cross_reference_bounces_200_response_cross_reference.crossReferenceBounces_200_response_cross_reference(
                    total_bounced = 56, 
                    matched = 56, 
                    unmatched = 56, 
                    match_rate = 1.337, 
                    entries = [
                        mailodds.models.cross_reference_bounces_200_response_cross_reference_entries_inner.crossReferenceBounces_200_response_cross_reference_entries_inner(
                            email = '', 
                            bounce_type = '', 
    ...
    def testCrossReferenceBounces200Response(self):
        """Test CrossReferenceBounces200Response"""
