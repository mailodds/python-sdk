...
class TestCrossReferenceBounces200ResponseCrossReference(unittest.TestCase):
    """CrossReferenceBounces200ResponseCrossReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CrossReferenceBounces200ResponseCrossReference:
        """Test CrossReferenceBounces200ResponseCrossReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CrossReferenceBounces200ResponseCrossReference`
        """
        model = CrossReferenceBounces200ResponseCrossReference()
        if include_optional:
    ...
    def testCrossReferenceBounces200ResponseCrossReference(self):
        """Test CrossReferenceBounces200ResponseCrossReference"""
