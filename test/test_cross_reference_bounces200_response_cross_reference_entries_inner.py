...
class TestCrossReferenceBounces200ResponseCrossReferenceEntriesInner(unittest.TestCase):
    """CrossReferenceBounces200ResponseCrossReferenceEntriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CrossReferenceBounces200ResponseCrossReferenceEntriesInner:
        """Test CrossReferenceBounces200ResponseCrossReferenceEntriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CrossReferenceBounces200ResponseCrossReferenceEntriesInner`
        """
        model = CrossReferenceBounces200ResponseCrossReferenceEntriesInner()
        if include_optional:
    ...
    def testCrossReferenceBounces200ResponseCrossReferenceEntriesInner(self):
        """Test CrossReferenceBounces200ResponseCrossReferenceEntriesInner"""
