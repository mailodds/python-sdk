...
class TestDeliverRequestOptions(unittest.TestCase):
    """DeliverRequestOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliverRequestOptions:
        """Test DeliverRequestOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliverRequestOptions`
        """
        model = DeliverRequestOptions()
        if include_optional:
    ...
    def testDeliverRequestOptions(self):
        """Test DeliverRequestOptions"""
