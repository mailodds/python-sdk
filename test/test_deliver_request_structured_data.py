...
class TestDeliverRequestStructuredData(unittest.TestCase):
    """DeliverRequestStructuredData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliverRequestStructuredData:
        """Test DeliverRequestStructuredData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliverRequestStructuredData`
        """
        model = DeliverRequestStructuredData()
        if include_optional:
    ...
    def testDeliverRequestStructuredData(self):
        """Test DeliverRequestStructuredData"""
