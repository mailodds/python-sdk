...
class TestDeliverResponse(unittest.TestCase):
    """DeliverResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliverResponse:
        """Test DeliverResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliverResponse`
        """
        model = DeliverResponse()
        if include_optional:
            return DeliverResponse(
                ...
                message_id = '',
                status = 'queued',
                delivery = mailodds.models.deliver_response_delivery.DeliverResponse_delivery(
                    pool = '', 
                    lane = '', 
                    warmup_limited = True, ),
                validation = None,
