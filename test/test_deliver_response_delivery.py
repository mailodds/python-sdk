...
class TestDeliverResponseDelivery(unittest.TestCase):
    """DeliverResponseDelivery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliverResponseDelivery:
        """Test DeliverResponseDelivery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliverResponseDelivery`
        """
        model = DeliverResponseDelivery()
        if include_optional:
    ...
    def testDeliverResponseDelivery(self):
        """Test DeliverResponseDelivery"""
