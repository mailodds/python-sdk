...
class TestDKIMManagementApi(unittest.TestCase):
    """DKIMManagementApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DKIMManagementApi()

    def tearDown(self) -> None:
        pass

    def test_get_dkim_dns_record(self) -> None:
        """Test case for get_dkim_dns_record

        Get DKIM DNS record
        """
        pass

    def test_rotate_dkim(self) -> None:
        """Test case for rotate_dkim
