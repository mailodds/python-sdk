...
class TestDmarcDomain(unittest.TestCase):
    """DmarcDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DmarcDomain:
        """Test DmarcDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DmarcDomain`
        """
        model = DmarcDomain()
        if include_optional:
            return DmarcDomain(
