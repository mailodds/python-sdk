...
class TestGetBlacklistHistory200Response(unittest.TestCase):
    """GetBlacklistHistory200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBlacklistHistory200Response:
        """Test GetBlacklistHistory200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBlacklistHistory200Response`
        """
        model = GetBlacklistHistory200Response()
        if include_optional:
            return GetBlacklistHistory200Response(
                schema_version = '',
                request_id = '',
                checks = [
                    mailodds.models.get_blacklist_history_200_response_checks_inner.getBlacklistHistory_200_response_checks_inner(
                        id = '', 
                        listed_on = [
                            ''
                            ], 
    ...
    def testGetBlacklistHistory200Response(self):
        """Test GetBlacklistHistory200Response"""
