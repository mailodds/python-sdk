...
class TestGetBlacklistHistory200ResponseChecksInner(unittest.TestCase):
    """GetBlacklistHistory200ResponseChecksInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBlacklistHistory200ResponseChecksInner:
        """Test GetBlacklistHistory200ResponseChecksInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBlacklistHistory200ResponseChecksInner`
        """
        model = GetBlacklistHistory200ResponseChecksInner()
        if include_optional:
    ...
    def testGetBlacklistHistory200ResponseChecksInner(self):
        """Test GetBlacklistHistory200ResponseChecksInner"""
