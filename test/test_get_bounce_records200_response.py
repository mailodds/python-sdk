...
class TestGetBounceRecords200Response(unittest.TestCase):
    """GetBounceRecords200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBounceRecords200Response:
        """Test GetBounceRecords200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBounceRecords200Response`
        """
        model = GetBounceRecords200Response()
        if include_optional:
            return GetBounceRecords200Response(
                schema_version = '',
                request_id = '',
                records = [
                    mailodds.models.get_bounce_records_200_response_records_inner.getBounceRecords_200_response_records_inner(
                        id = '', 
                        email = '', 
                        bounce_type = 'hard', 
                        smtp_code = 56, 
    ...
    def testGetBounceRecords200Response(self):
        """Test GetBounceRecords200Response"""
