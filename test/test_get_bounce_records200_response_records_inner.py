...
class TestGetBounceRecords200ResponseRecordsInner(unittest.TestCase):
    """GetBounceRecords200ResponseRecordsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBounceRecords200ResponseRecordsInner:
        """Test GetBounceRecords200ResponseRecordsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBounceRecords200ResponseRecordsInner`
        """
        model = GetBounceRecords200ResponseRecordsInner()
        if include_optional:
    ...
    def testGetBounceRecords200ResponseRecordsInner(self):
        """Test GetBounceRecords200ResponseRecordsInner"""
