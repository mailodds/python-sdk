...
class TestGetCampaignABResults200ResponseVariantsInner(unittest.TestCase):
    """GetCampaignABResults200ResponseVariantsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignABResults200ResponseVariantsInner:
        """Test GetCampaignABResults200ResponseVariantsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignABResults200ResponseVariantsInner`
        """
        model = GetCampaignABResults200ResponseVariantsInner()
        if include_optional:
    ...
    def testGetCampaignABResults200ResponseVariantsInner(self):
        """Test GetCampaignABResults200ResponseVariantsInner"""
