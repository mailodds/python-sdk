...
class TestGetCampaignABResults200ResponseWinner(unittest.TestCase):
    """GetCampaignABResults200ResponseWinner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignABResults200ResponseWinner:
        """Test GetCampaignABResults200ResponseWinner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignABResults200ResponseWinner`
        """
        model = GetCampaignABResults200ResponseWinner()
        if include_optional:
    ...
    def testGetCampaignABResults200ResponseWinner(self):
        """Test GetCampaignABResults200ResponseWinner"""
