...
class TestGetCampaignAttribution200Response(unittest.TestCase):
    """GetCampaignAttribution200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignAttribution200Response:
        """Test GetCampaignAttribution200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignAttribution200Response`
        """
        model = GetCampaignAttribution200Response()
        if include_optional:
            return GetCampaignAttribution200Response(
                schema_version = '',
                request_id = '',
                campaign_id = '',
                attribution = mailodds.models.get_campaign_attribution_200_response_attribution.getCampaignAttribution_200_response_attribution(
                    first_touch = mailodds.models.get_campaign_attribution_200_response_attribution_first_touch.getCampaignAttribution_200_response_attribution_first_touch(
                        conversions = 56, 
                        revenue = 1.337, ), 
                    last_touch = mailodds.models.get_campaign_attribution_200_response_attribution_first_touch.getCampaignAttribution_200_response_attribution_first_touch(
                        conversions = 56, 
                        revenue = 1.337, ), )
            )
        else:
    ...
    def testGetCampaignAttribution200Response(self):
        """Test GetCampaignAttribution200Response"""
