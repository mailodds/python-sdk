...
class TestGetCampaignAttribution200ResponseAttribution(unittest.TestCase):
    """GetCampaignAttribution200ResponseAttribution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignAttribution200ResponseAttribution:
        """Test GetCampaignAttribution200ResponseAttribution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignAttribution200ResponseAttribution`
        """
        model = GetCampaignAttribution200ResponseAttribution()
        if include_optional:
    ...
    def testGetCampaignAttribution200ResponseAttribution(self):
        """Test GetCampaignAttribution200ResponseAttribution"""
