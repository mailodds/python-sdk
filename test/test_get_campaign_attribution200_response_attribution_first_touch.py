...
class TestGetCampaignAttribution200ResponseAttributionFirstTouch(unittest.TestCase):
    """GetCampaignAttribution200ResponseAttributionFirstTouch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignAttribution200ResponseAttributionFirstTouch:
        """Test GetCampaignAttribution200ResponseAttributionFirstTouch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignAttribution200ResponseAttributionFirstTouch`
        """
        model = GetCampaignAttribution200ResponseAttributionFirstTouch()
        if include_optional:
    ...
    def testGetCampaignAttribution200ResponseAttributionFirstTouch(self):
        """Test GetCampaignAttribution200ResponseAttributionFirstTouch"""
