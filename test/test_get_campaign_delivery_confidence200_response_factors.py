...
class TestGetCampaignDeliveryConfidence200ResponseFactors(unittest.TestCase):
    """GetCampaignDeliveryConfidence200ResponseFactors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignDeliveryConfidence200ResponseFactors:
        """Test GetCampaignDeliveryConfidence200ResponseFactors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignDeliveryConfidence200ResponseFactors`
        """
        model = GetCampaignDeliveryConfidence200ResponseFactors()
        if include_optional:
    ...
    def testGetCampaignDeliveryConfidence200ResponseFactors(self):
        """Test GetCampaignDeliveryConfidence200ResponseFactors"""
