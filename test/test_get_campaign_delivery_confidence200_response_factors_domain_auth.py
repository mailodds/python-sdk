...
class TestGetCampaignDeliveryConfidence200ResponseFactorsDomainAuth(unittest.TestCase):
    """GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth:
        """Test GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth`
        """
        model = GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth()
        if include_optional:
    ...
    def testGetCampaignDeliveryConfidence200ResponseFactorsDomainAuth(self):
        """Test GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth"""
