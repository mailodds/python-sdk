...
class TestGetCampaignDeliveryConfidence200ResponseFactorsListQuality(unittest.TestCase):
    """GetCampaignDeliveryConfidence200ResponseFactorsListQuality unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignDeliveryConfidence200ResponseFactorsListQuality:
        """Test GetCampaignDeliveryConfidence200ResponseFactorsListQuality
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignDeliveryConfidence200ResponseFactorsListQuality`
        """
        model = GetCampaignDeliveryConfidence200ResponseFactorsListQuality()
        if include_optional:
    ...
    def testGetCampaignDeliveryConfidence200ResponseFactorsListQuality(self):
        """Test GetCampaignDeliveryConfidence200ResponseFactorsListQuality"""
