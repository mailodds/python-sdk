...
class TestGetCampaignDeliveryConfidence200ResponseFactorsSenderReputation(unittest.TestCase):
    """GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation:
        """Test GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation`
        """
        model = GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation()
        if include_optional:
    ...
    def testGetCampaignDeliveryConfidence200ResponseFactorsSenderReputation(self):
        """Test GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation"""
