...
class TestGetCampaignFunnel200Response(unittest.TestCase):
    """GetCampaignFunnel200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignFunnel200Response:
        """Test GetCampaignFunnel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignFunnel200Response`
        """
        model = GetCampaignFunnel200Response()
        if include_optional:
            return GetCampaignFunnel200Response(
                schema_version = '',
                request_id = '',
                campaign_id = '',
                funnel = mailodds.models.get_campaign_funnel_200_response_funnel.getCampaignFunnel_200_response_funnel(
                    sent = 56, 
                    delivered = 56, 
                    opened = 56, 
                    clicked = 56, 
                    ...
                    bounced = 56, 
                    complained = 56, ),
                rates = mailodds.models.get_campaign_funnel_200_response_rates.getCampaignFunnel_200_response_rates(
                    delivery_rate = 1.337, 
                    open_rate = 1.337, 
                    click_rate = 1.337, 
                    click_to_open_rate = 1.337, 
                    bounce_rate = 1.337, 
                    unsubscribe_rate = 1.337, 
    ...
    def testGetCampaignFunnel200Response(self):
        """Test GetCampaignFunnel200Response"""
