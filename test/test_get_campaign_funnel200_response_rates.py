...
class TestGetCampaignFunnel200ResponseRates(unittest.TestCase):
    """GetCampaignFunnel200ResponseRates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignFunnel200ResponseRates:
        """Test GetCampaignFunnel200ResponseRates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignFunnel200ResponseRates`
        """
        model = GetCampaignFunnel200ResponseRates()
        if include_optional:
    ...
    def testGetCampaignFunnel200ResponseRates(self):
        """Test GetCampaignFunnel200ResponseRates"""
