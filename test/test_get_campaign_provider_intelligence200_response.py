...
class TestGetCampaignProviderIntelligence200Response(unittest.TestCase):
    """GetCampaignProviderIntelligence200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignProviderIntelligence200Response:
        """Test GetCampaignProviderIntelligence200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignProviderIntelligence200Response`
        """
        model = GetCampaignProviderIntelligence200Response()
        if include_optional:
            return GetCampaignProviderIntelligence200Response(
                ...
                campaign_id = '',
                providers = [
                    mailodds.models.get_campaign_provider_intelligence_200_response_providers_inner.getCampaignProviderIntelligence_200_response_providers_inner(
                        provider = '', 
                        sent = 56, 
                        delivered = 56, 
                        bounced = 56, 
    ...
    def testGetCampaignProviderIntelligence200Response(self):
        """Test GetCampaignProviderIntelligence200Response"""
