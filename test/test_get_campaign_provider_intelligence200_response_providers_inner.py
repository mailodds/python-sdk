...
class TestGetCampaignProviderIntelligence200ResponseProvidersInner(unittest.TestCase):
    """GetCampaignProviderIntelligence200ResponseProvidersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCampaignProviderIntelligence200ResponseProvidersInner:
        """Test GetCampaignProviderIntelligence200ResponseProvidersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCampaignProviderIntelligence200ResponseProvidersInner`
        """
        model = GetCampaignProviderIntelligence200ResponseProvidersInner()
        if include_optional:
    ...
    def testGetCampaignProviderIntelligence200ResponseProvidersInner(self):
        """Test GetCampaignProviderIntelligence200ResponseProvidersInner"""
