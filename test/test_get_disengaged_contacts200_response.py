...
class TestGetDisengagedContacts200Response(unittest.TestCase):
    """GetDisengagedContacts200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDisengagedContacts200Response:
        """Test GetDisengagedContacts200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDisengagedContacts200Response`
        """
        model = GetDisengagedContacts200Response()
        if include_optional:
            return GetDisengagedContacts200Response(
                ...
                pagination = mailodds.models.get_disengaged_contacts_200_response_pagination.getDisengagedContacts_200_response_pagination(
                    page = 56, 
                    per_page = 56, 
                    total = 56, 
                    total_pages = 56, 
    ...
    def testGetDisengagedContacts200Response(self):
        """Test GetDisengagedContacts200Response"""
