...
class TestGetDisengagedContacts200ResponsePagination(unittest.TestCase):
    """GetDisengagedContacts200ResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDisengagedContacts200ResponsePagination:
        """Test GetDisengagedContacts200ResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDisengagedContacts200ResponsePagination`
        """
        model = GetDisengagedContacts200ResponsePagination()
        if include_optional:
    ...
    def testGetDisengagedContacts200ResponsePagination(self):
        """Test GetDisengagedContacts200ResponsePagination"""
