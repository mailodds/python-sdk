...
class TestGetDmarcDomain200ResponseDomain(unittest.TestCase):
    """GetDmarcDomain200ResponseDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDmarcDomain200ResponseDomain:
        """Test GetDmarcDomain200ResponseDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDmarcDomain200ResponseDomain`
        """
        model = GetDmarcDomain200ResponseDomain()
        if include_optional:
    ...
    def testGetDmarcDomain200ResponseDomain(self):
        """Test GetDmarcDomain200ResponseDomain"""
