...
class TestGetDmarcRecommendation200Response(unittest.TestCase):
    """GetDmarcRecommendation200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDmarcRecommendation200Response:
        """Test GetDmarcRecommendation200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDmarcRecommendation200Response`
        """
        model = GetDmarcRecommendation200Response()
        if include_optional:
            return GetDmarcRecommendation200Response(
                schema_version = '',
                request_id = '',
                recommendation = mailodds.models.get_dmarc_recommendation_200_response_recommendation.getDmarcRecommendation_200_response_recommendation(
                    current_policy = '', 
                    recommended_policy = '', 
                    confidence = 1.337, 
                    reasons = [
    ...
    def testGetDmarcRecommendation200Response(self):
        """Test GetDmarcRecommendation200Response"""
