...
class TestGetDmarcRecommendation200ResponseRecommendation(unittest.TestCase):
    """GetDmarcRecommendation200ResponseRecommendation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDmarcRecommendation200ResponseRecommendation:
        """Test GetDmarcRecommendation200ResponseRecommendation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDmarcRecommendation200ResponseRecommendation`
        """
        model = GetDmarcRecommendation200ResponseRecommendation()
        if include_optional:
    ...
    def testGetDmarcRecommendation200ResponseRecommendation(self):
        """Test GetDmarcRecommendation200ResponseRecommendation"""
