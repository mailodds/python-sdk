...
class TestGetDmarcSources200Response(unittest.TestCase):
    """GetDmarcSources200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDmarcSources200Response:
        """Test GetDmarcSources200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDmarcSources200Response`
        """
        model = GetDmarcSources200Response()
        if include_optional:
            return GetDmarcSources200Response(
                schema_version = '',
                request_id = '',
                sources = [
                    mailodds.models.get_dmarc_sources_200_response_sources_inner.getDmarcSources_200_response_sources_inner(
                        source_ip = '', 
                        hostname = '', 
                        org = '', 
                        count = 56, 
    ...
    def testGetDmarcSources200Response(self):
        """Test GetDmarcSources200Response"""
