...
class TestGetDmarcTrend200ResponseTrendInner(unittest.TestCase):
    """GetDmarcTrend200ResponseTrendInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDmarcTrend200ResponseTrendInner:
        """Test GetDmarcTrend200ResponseTrendInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDmarcTrend200ResponseTrendInner`
        """
        model = GetDmarcTrend200ResponseTrendInner()
        if include_optional:
    ...
    def testGetDmarcTrend200ResponseTrendInner(self):
        """Test GetDmarcTrend200ResponseTrendInner"""
