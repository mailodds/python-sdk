...
class TestGetEngagementScore200Response(unittest.TestCase):
    """GetEngagementScore200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEngagementScore200Response:
        """Test GetEngagementScore200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEngagementScore200Response`
        """
        model = GetEngagementScore200Response()
        if include_optional:
            return GetEngagementScore200Response(
                ...
                email = '',
                score = 1.337,
                last_engaged_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f')
            )
        else:
            return GetEngagementScore200Response(
        )
    ...
    def testGetEngagementScore200Response(self):
        """Test GetEngagementScore200Response"""
