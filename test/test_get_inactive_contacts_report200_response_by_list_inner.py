...
class TestGetInactiveContactsReport200ResponseByListInner(unittest.TestCase):
    """GetInactiveContactsReport200ResponseByListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInactiveContactsReport200ResponseByListInner:
        """Test GetInactiveContactsReport200ResponseByListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInactiveContactsReport200ResponseByListInner`
        """
        model = GetInactiveContactsReport200ResponseByListInner()
        if include_optional:
    ...
    def testGetInactiveContactsReport200ResponseByListInner(self):
        """Test GetInactiveContactsReport200ResponseByListInner"""
