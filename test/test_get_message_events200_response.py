...
class TestGetMessageEvents200Response(unittest.TestCase):
    """GetMessageEvents200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMessageEvents200Response:
        """Test GetMessageEvents200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMessageEvents200Response`
        """
        model = GetMessageEvents200Response()
        if include_optional:
            return GetMessageEvents200Response(
                ...
                message_id = '',
                recipient = '',
                summary = mailodds.models.get_message_events_200_response_summary.getMessageEvents_200_response_summary(
                    delivered = True, 
                    bounced = True, 
                    human_opens = 56, 
                    bot_opens = 56, 
                    ...
                    unsubscribed = True, ),
                clicks = [
                    mailodds.models.get_message_events_200_response_clicks_inner.getMessageEvents_200_response_clicks_inner(
                        url = '', 
                        is_bot = True, 
                        timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
                    ],
                events = [
                    mailodds.models.get_message_events_200_response_events_inner.getMessageEvents_200_response_events_inner(
                        id = '', 
                        event_type = '', 
                        is_bot = True, 
                        link_url = '', 
    ...
    def testGetMessageEvents200Response(self):
        """Test GetMessageEvents200Response"""
