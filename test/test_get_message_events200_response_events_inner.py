...
class TestGetMessageEvents200ResponseEventsInner(unittest.TestCase):
    """GetMessageEvents200ResponseEventsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMessageEvents200ResponseEventsInner:
        """Test GetMessageEvents200ResponseEventsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMessageEvents200ResponseEventsInner`
        """
        model = GetMessageEvents200ResponseEventsInner()
        if include_optional:
    ...
    def testGetMessageEvents200ResponseEventsInner(self):
        """Test GetMessageEvents200ResponseEventsInner"""
