...
class TestGetMessageEvents200ResponseSummary(unittest.TestCase):
    """GetMessageEvents200ResponseSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMessageEvents200ResponseSummary:
        """Test GetMessageEvents200ResponseSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMessageEvents200ResponseSummary`
        """
        model = GetMessageEvents200ResponseSummary()
        if include_optional:
    ...
    def testGetMessageEvents200ResponseSummary(self):
        """Test GetMessageEvents200ResponseSummary"""
