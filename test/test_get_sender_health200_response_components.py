...
class TestGetSenderHealth200ResponseComponents(unittest.TestCase):
    """GetSenderHealth200ResponseComponents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSenderHealth200ResponseComponents:
        """Test GetSenderHealth200ResponseComponents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSenderHealth200ResponseComponents`
        """
        model = GetSenderHealth200ResponseComponents()
        if include_optional:
            return GetSenderHealth200ResponseComponents(
                delivery_rate = mailodds.models.get_sender_health_200_response_components_delivery_rate.getSenderHealth_200_response_components_delivery_rate(
                    value = 1.337, 
                    score = 56, 
                    weight = 1.337, ),
                bounce_rate = mailodds.models.get_sender_health_200_response_components_delivery_rate.getSenderHealth_200_response_components_delivery_rate(
                    value = 1.337, 
                    score = 56, 
                    weight = 1.337, ),
                complaint_rate = mailodds.models.get_sender_health_200_response_components_delivery_rate.getSenderHealth_200_response_components_delivery_rate(
                    value = 1.337, 
                    score = 56, 
                    weight = 1.337, ),
                authentication = mailodds.models.get_sender_health_200_response_components_delivery_rate.getSenderHealth_200_response_components_delivery_rate(
                    value = 1.337, 
                    score = 56, 
                    weight = 1.337, )
            )
    ...
    def testGetSenderHealth200ResponseComponents(self):
        """Test GetSenderHealth200ResponseComponents"""
