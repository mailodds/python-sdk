...
class TestGetSenderHealth200ResponseComponentsDeliveryRate(unittest.TestCase):
    """GetSenderHealth200ResponseComponentsDeliveryRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSenderHealth200ResponseComponentsDeliveryRate:
        """Test GetSenderHealth200ResponseComponentsDeliveryRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSenderHealth200ResponseComponentsDeliveryRate`
        """
        model = GetSenderHealth200ResponseComponentsDeliveryRate()
        if include_optional:
    ...
    def testGetSenderHealth200ResponseComponentsDeliveryRate(self):
        """Test GetSenderHealth200ResponseComponentsDeliveryRate"""
