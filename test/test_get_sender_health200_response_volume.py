...
class TestGetSenderHealth200ResponseVolume(unittest.TestCase):
    """GetSenderHealth200ResponseVolume unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSenderHealth200ResponseVolume:
        """Test GetSenderHealth200ResponseVolume
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSenderHealth200ResponseVolume`
        """
        model = GetSenderHealth200ResponseVolume()
        if include_optional:
    ...
    def testGetSenderHealth200ResponseVolume(self):
        """Test GetSenderHealth200ResponseVolume"""
