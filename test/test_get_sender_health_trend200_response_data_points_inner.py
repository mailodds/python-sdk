...
class TestGetSenderHealthTrend200ResponseDataPointsInner(unittest.TestCase):
    """GetSenderHealthTrend200ResponseDataPointsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSenderHealthTrend200ResponseDataPointsInner:
        """Test GetSenderHealthTrend200ResponseDataPointsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSenderHealthTrend200ResponseDataPointsInner`
        """
        model = GetSenderHealthTrend200ResponseDataPointsInner()
        if include_optional:
    ...
    def testGetSenderHealthTrend200ResponseDataPointsInner(self):
        """Test GetSenderHealthTrend200ResponseDataPointsInner"""
