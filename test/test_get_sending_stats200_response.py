...
class TestGetSendingStats200Response(unittest.TestCase):
    """GetSendingStats200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSendingStats200Response:
        """Test GetSendingStats200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSendingStats200Response`
        """
        model = GetSendingStats200Response()
        if include_optional:
            return GetSendingStats200Response(
                stats = mailodds.models.get_sending_stats_200_response_stats.getSendingStats_200_response_stats(
                    period = '', 
                    sent = 56, 
                    delivered = 56, 
                    bounced = 56, 
    ...
    def testGetSendingStats200Response(self):
        """Test GetSendingStats200Response"""
