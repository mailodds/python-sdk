...
class TestGetSendingStats200ResponseStats(unittest.TestCase):
    """GetSendingStats200ResponseStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSendingStats200ResponseStats:
        """Test GetSendingStats200ResponseStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSendingStats200ResponseStats`
        """
        model = GetSendingStats200ResponseStats()
        if include_optional:
    ...
    def testGetSendingStats200ResponseStats(self):
        """Test GetSendingStats200ResponseStats"""
