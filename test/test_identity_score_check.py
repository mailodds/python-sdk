...
class TestIdentityScoreCheck(unittest.TestCase):
    """IdentityScoreCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityScoreCheck:
        """Test IdentityScoreCheck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityScoreCheck`
        """
        model = IdentityScoreCheck()
        if include_optional:
    ...
    def testIdentityScoreCheck(self):
        """Test IdentityScoreCheck"""
