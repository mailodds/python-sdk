...
class TestISPFBLGuidesApi(unittest.TestCase):
    """ISPFBLGuidesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ISPFBLGuidesApi()

    def tearDown(self) -> None:
        pass

    def test_get_isp_fbl_guide(self) -> None:
        """Test case for get_isp_fbl_guide

        Get ISP FBL guide
        """
        pass

    def test_list_isp_fbl_guides(self) -> None:
        """Test case for list_isp_fbl_guides
