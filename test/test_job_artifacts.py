...
class TestJobArtifacts(unittest.TestCase):
    """JobArtifacts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobArtifacts:
        """Test JobArtifacts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobArtifacts`
        """
        model = JobArtifacts()
        if include_optional:
            return JobArtifacts(
