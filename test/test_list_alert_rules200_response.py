...
class TestListAlertRules200Response(unittest.TestCase):
    """ListAlertRules200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAlertRules200Response:
        """Test ListAlertRules200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAlertRules200Response`
        """
        model = ListAlertRules200Response()
        if include_optional:
            return ListAlertRules200Response(
                schema_version = '',
                request_id = '',
                rules = [
                    mailodds.models.alert_rule.AlertRule(
                        id = '', 
                        metric = '', 
                        threshold = 0, 
                        channel = '', 
    ...
    def testListAlertRules200Response(self):
        """Test ListAlertRules200Response"""
