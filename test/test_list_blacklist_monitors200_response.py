...
class TestListBlacklistMonitors200Response(unittest.TestCase):
    """ListBlacklistMonitors200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListBlacklistMonitors200Response:
        """Test ListBlacklistMonitors200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListBlacklistMonitors200Response`
        """
        model = ListBlacklistMonitors200Response()
        if include_optional:
            return ListBlacklistMonitors200Response(
                schema_version = '',
                request_id = '',
                monitors = [
                    mailodds.models.blacklist_monitor.BlacklistMonitor(
                        id = '', 
                        target = '', 
                        target_type = 'ip', 
                        status = '', 
    ...
    def testListBlacklistMonitors200Response(self):
        """Test ListBlacklistMonitors200Response"""
