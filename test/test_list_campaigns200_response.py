...
class TestListCampaigns200Response(unittest.TestCase):
    """ListCampaigns200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCampaigns200Response:
        """Test ListCampaigns200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCampaigns200Response`
        """
        model = ListCampaigns200Response()
        if include_optional:
            return ListCampaigns200Response(
                schema_version = '',
                request_id = '',
                campaigns = [
                    mailodds.models.campaign.Campaign(
                        id = '', 
                        account_id = 56, 
                        name = '', 
                        status = 'draft', 
                        ...
                        promo_annotations = mailodds.models.promo_annotations.promo_annotations(), 
                        throwaway_policy = '', 
                        ...
                        is_ab_test = True, 
                        winning_variant_id = '', 
                        ab_test_config = mailodds.models.ab_test_config.ab_test_config(), 
                        error_message = '', 
                        stats = mailodds.models.campaign_stats.Campaign_stats(
                            sent = 56, 
                            delivered = 56, 
                            opened = 56, 
                            clicked = 56, 
    ...
    def testListCampaigns200Response(self):
        """Test ListCampaigns200Response"""
