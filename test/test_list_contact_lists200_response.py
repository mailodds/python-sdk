...
class TestListContactLists200Response(unittest.TestCase):
    """ListContactLists200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListContactLists200Response:
        ...
        """
        model = ListContactLists200Response()
        if include_optional:
            return ListContactLists200Response(
                schema_version = '',
                request_id = '',
                contact_lists = [
                    mailodds.models.contact_list.ContactList(
                        id = '', 
                        name = '', 
                        email_count = 56, 
                        tags = [
    ...
    def testListContactLists200Response(self):
        """Test ListContactLists200Response"""
