...
class TestListDmarcDomains200Response(unittest.TestCase):
    """ListDmarcDomains200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDmarcDomains200Response:
        """Test ListDmarcDomains200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListDmarcDomains200Response`
        """
        model = ListDmarcDomains200Response()
        if include_optional:
            return ListDmarcDomains200Response(
                schema_version = '',
                request_id = '',
                domains = [
                    mailodds.models.dmarc_domain.DmarcDomain(
                        id = '', 
                        domain = '', 
                        reporting_address = '', 
                        dns_verified = True, 
    ...
    def testListDmarcDomains200Response(self):
        """Test ListDmarcDomains200Response"""
