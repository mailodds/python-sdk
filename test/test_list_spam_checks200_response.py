...
class TestListSpamChecks200Response(unittest.TestCase):
    """ListSpamChecks200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListSpamChecks200Response:
        """Test ListSpamChecks200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListSpamChecks200Response`
        """
        model = ListSpamChecks200Response()
        if include_optional:
            return ListSpamChecks200Response(
                schema_version = '',
                request_id = '',
                spam_checks = [
                    mailodds.models.spam_check.SpamCheck(
                        id = '', 
                        from_domain = '', 
                        score = 1.337, 
                        verdict = '', 
                        checks = mailodds.models.spam_check_checks.SpamCheck_checks(
                            domain_reputation = mailodds.models.domain_reputation.domain_reputation(), 
                            link_safety = mailodds.models.link_safety.link_safety(), 
                            subject_analysis = mailodds.models.subject_analysis.subject_analysis(), ), 
    ...
    def testListSpamChecks200Response(self):
        """Test ListSpamChecks200Response"""
