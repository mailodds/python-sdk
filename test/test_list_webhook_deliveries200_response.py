...
class TestListWebhookDeliveries200Response(unittest.TestCase):
    """ListWebhookDeliveries200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListWebhookDeliveries200Response:
        """Test ListWebhookDeliveries200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListWebhookDeliveries200Response`
        """
        model = ListWebhookDeliveries200Response()
        if include_optional:
            return ListWebhookDeliveries200Response(
                deliveries = [
                    mailodds.models.list_webhook_deliveries_200_response_deliveries_inner.listWebhookDeliveries_200_response_deliveries_inner(
                        id = 56, 
                        event_type = '', 
                        status = '', 
                        status_code = 56, 
    ...
    def testListWebhookDeliveries200Response(self):
        """Test ListWebhookDeliveries200Response"""
