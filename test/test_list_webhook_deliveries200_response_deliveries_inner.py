...
class TestListWebhookDeliveries200ResponseDeliveriesInner(unittest.TestCase):
    """ListWebhookDeliveries200ResponseDeliveriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListWebhookDeliveries200ResponseDeliveriesInner:
        """Test ListWebhookDeliveries200ResponseDeliveriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListWebhookDeliveries200ResponseDeliveriesInner`
        """
        model = ListWebhookDeliveries200ResponseDeliveriesInner()
        if include_optional:
    ...
    def testListWebhookDeliveries200ResponseDeliveriesInner(self):
        """Test ListWebhookDeliveries200ResponseDeliveriesInner"""
