...
class TestMcpCapabilities(unittest.TestCase):
    """McpCapabilities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> McpCapabilities:
        """Test McpCapabilities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `McpCapabilities`
        """
        model = McpCapabilities()
        if include_optional:
            return McpCapabilities(
                ...
                tool_count = 56,
                pillars = [
                    mailodds.models.mcp_capabilities_pillars_inner.McpCapabilities_pillars_inner(
                        name = '', 
                        tool_count = 56, 
                        tools = [
