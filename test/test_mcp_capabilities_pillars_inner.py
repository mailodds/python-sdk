...
class TestMcpCapabilitiesPillarsInner(unittest.TestCase):
    """McpCapabilitiesPillarsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> McpCapabilitiesPillarsInner:
        """Test McpCapabilitiesPillarsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `McpCapabilitiesPillarsInner`
        """
        model = McpCapabilitiesPillarsInner()
        if include_optional:
            return McpCapabilitiesPillarsInner(
                name = '',
                tool_count = 56,
                tools = [
                    mailodds.models.mcp_capabilities_pillars_inner_tools_inner.McpCapabilities_pillars_inner_tools_inner(
                        name = '', 
                        required_scope = '', )
                    ]
            )
    ...
    def testMcpCapabilitiesPillarsInner(self):
        """Test McpCapabilitiesPillarsInner"""
