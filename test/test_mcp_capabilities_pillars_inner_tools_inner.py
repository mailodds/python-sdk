...
class TestMcpCapabilitiesPillarsInnerToolsInner(unittest.TestCase):
    """McpCapabilitiesPillarsInnerToolsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> McpCapabilitiesPillarsInnerToolsInner:
        """Test McpCapabilitiesPillarsInnerToolsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `McpCapabilitiesPillarsInnerToolsInner`
        """
        model = McpCapabilitiesPillarsInnerToolsInner()
        if include_optional:
    ...
    def testMcpCapabilitiesPillarsInnerToolsInner(self):
        """Test McpCapabilitiesPillarsInnerToolsInner"""
