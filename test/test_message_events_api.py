...
class TestMessageEventsApi(unittest.TestCase):
    """MessageEventsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MessageEventsApi()

    def tearDown(self) -> None:
        pass

    def test_get_message_events(self) -> None:
        """Test case for get_message_events
