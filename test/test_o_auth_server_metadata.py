...
class TestOAuthServerMetadata(unittest.TestCase):
    """OAuthServerMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuthServerMetadata:
        """Test OAuthServerMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuthServerMetadata`
        """
        model = OAuthServerMetadata()
        if include_optional:
    ...
    def testOAuthServerMetadata(self):
        """Test OAuthServerMetadata"""
