...
class TestOutOfOfficeApi(unittest.TestCase):
    """OutOfOfficeApi unit test stubs"""

    def setUp(self) -> None:
        self.api = OutOfOfficeApi()

    def tearDown(self) -> None:
        pass

    def test_batch_check_ooo(self) -> None:
        """Test case for batch_check_ooo

        Batch check OOO status
        """
        pass

    def test_delete_ooo_contact(self) -> None:
        """Test case for delete_ooo_contact

        Delete OOO contact
        """
        pass

    def test_get_ooo_status(self) -> None:
        """Test case for get_ooo_status

        Get OOO status for email
        """
        pass

    def test_list_ooo_contacts(self) -> None:
        """Test case for list_ooo_contacts

        List out-of-office contacts
        """
        pass

    def test_update_ooo_contact(self) -> None:
        """Test case for update_ooo_contact
