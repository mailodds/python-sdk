...
class TestPipelineSimulationApi(unittest.TestCase):
    """PipelineSimulationApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PipelineSimulationApi()

    def tearDown(self) -> None:
        pass

    def test_simulate_pipeline(self) -> None:
        """Test case for simulate_pipeline
