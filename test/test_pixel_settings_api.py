...
class TestPixelSettingsApi(unittest.TestCase):
    """PixelSettingsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PixelSettingsApi()

    def tearDown(self) -> None:
        pass

    def test_get_pixel_settings(self) -> None:
        """Test case for get_pixel_settings

        Get pixel settings
        """
        pass

    def test_update_pixel_settings(self) -> None:
        """Test case for update_pixel_settings
