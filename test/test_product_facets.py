...
class TestProductFacets(unittest.TestCase):
    """ProductFacets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductFacets:
        """Test ProductFacets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductFacets`
        """
        model = ProductFacets()
        if include_optional:
