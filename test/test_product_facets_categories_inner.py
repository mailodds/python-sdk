...
class TestProductFacetsCategoriesInner(unittest.TestCase):
    """ProductFacetsCategoriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductFacetsCategoriesInner:
        """Test ProductFacetsCategoriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductFacetsCategoriesInner`
        """
        model = ProductFacetsCategoriesInner()
        if include_optional:
    ...
    def testProductFacetsCategoriesInner(self):
        """Test ProductFacetsCategoriesInner"""
