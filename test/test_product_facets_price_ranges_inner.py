...
class TestProductFacetsPriceRangesInner(unittest.TestCase):
    """ProductFacetsPriceRangesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductFacetsPriceRangesInner:
        """Test ProductFacetsPriceRangesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductFacetsPriceRangesInner`
        """
        model = ProductFacetsPriceRangesInner()
        if include_optional:
    ...
    def testProductFacetsPriceRangesInner(self):
        """Test ProductFacetsPriceRangesInner"""
