...
class TestProductFacetsStoresInner(unittest.TestCase):
    """ProductFacetsStoresInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductFacetsStoresInner:
        """Test ProductFacetsStoresInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductFacetsStoresInner`
        """
        model = ProductFacetsStoresInner()
        if include_optional:
    ...
    def testProductFacetsStoresInner(self):
        """Test ProductFacetsStoresInner"""
