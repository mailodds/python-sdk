...
class TestQueryContactList200Response(unittest.TestCase):
    """QueryContactList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryContactList200Response:
        """Test QueryContactList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryContactList200Response`
        """
        model = QueryContactList200Response()
        if include_optional:
            return QueryContactList200Response(
                schema_version = '',
                request_id = '',
                emails = [
                    mailodds.models.query_contact_list_200_response_emails_inner.queryContactList_200_response_emails_inner(
                        email = '', 
                        status = '', 
                        domain = '', 
    ...
    def testQueryContactList200Response(self):
        """Test QueryContactList200Response"""
