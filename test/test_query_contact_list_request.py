...
class TestQueryContactListRequest(unittest.TestCase):
    """QueryContactListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryContactListRequest:
        """Test QueryContactListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryContactListRequest`
        """
        model = QueryContactListRequest()
        if include_optional:
            return QueryContactListRequest(
                filters = [
                    mailodds.models.query_contact_list_request_filters_inner.queryContactList_request_filters_inner(
                        field = '', 
                        operator = 'eq', 
                        value = null, )
                    ],
    ...
    def testQueryContactListRequest(self):
        """Test QueryContactListRequest"""
