...
class TestQueryContactListRequestFiltersInner(unittest.TestCase):
    """QueryContactListRequestFiltersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryContactListRequestFiltersInner:
        """Test QueryContactListRequestFiltersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryContactListRequestFiltersInner`
        """
        model = QueryContactListRequestFiltersInner()
        if include_optional:
    ...
    def testQueryContactListRequestFiltersInner(self):
        """Test QueryContactListRequestFiltersInner"""
