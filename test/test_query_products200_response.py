...
class TestQueryProducts200Response(unittest.TestCase):
    """QueryProducts200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryProducts200Response:
        """Test QueryProducts200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryProducts200Response`
        """
        model = QueryProducts200Response()
        if include_optional:
            return QueryProducts200Response(
                schema_version = '',
                request_id = '',
                products = [
                    mailodds.models.store_product.StoreProduct(
                        id = '', 
                        store_id = '', 
                        external_id = '', 
                        sku = '', 
                        ...
                        description = '', 
                        price_current = 1.337, 
                        price_original = 1.337, 
                        currency = 'USD', 
                        sale_start = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        sale_end = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                per_page = 56,
                pages = 56,
                facets = mailodds.models.product_facets.ProductFacets(
                    categories = [
                        mailodds.models.product_facets_categories_inner.ProductFacets_categories_inner(
                            name = '', 
                            count = 56, )
                        ], 
                    price_ranges = [
                        mailodds.models.product_facets_price_ranges_inner.ProductFacets_price_ranges_inner(
                            range = '', 
                            count = 56, )
                        ], 
                    stores = [
                        mailodds.models.product_facets_stores_inner.ProductFacets_stores_inner(
                            store_id = '', 
                            store_name = '', 
                            count = 56, )
                        ], )
    ...
    def testQueryProducts200Response(self):
        """Test QueryProducts200Response"""
