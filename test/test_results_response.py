        ...
        if include_optional:
            return ResultsResponse(
                ...
                job = mailodds.models.job.Job(
                    ...
                    results_expire_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    metadata = mailodds.models.metadata.metadata(), 
                    error_message = '', 
                    request_id = '', 
                    artifacts = mailodds.models.job_artifacts.Job_artifacts(
                        csv_all = '', 
                        csv_valid = '', 
                        csv_invalid = '', ), ),
                data = [
                    mailodds.models.validation_result.ValidationResult(
                        ...
                        mx_host = '', 
                        checks = { }, 
                        suppression = mailodds.models.validation_result_suppression.ValidationResult_suppression(
                            match_type = 'email', 
                            match_value = '', ), 
