...
class TestRunBlacklistCheck200Response(unittest.TestCase):
    """RunBlacklistCheck200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunBlacklistCheck200Response:
        """Test RunBlacklistCheck200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunBlacklistCheck200Response`
        """
        model = RunBlacklistCheck200Response()
        if include_optional:
            return RunBlacklistCheck200Response(
                schema_version = '',
                request_id = '',
                monitor = mailodds.models.blacklist_monitor.BlacklistMonitor(
                    id = '', 
                    target = '', 
                    target_type = 'ip', 
                    status = '', 
                    ...
                    latest_check = mailodds.models.blacklist_monitor_latest_check.BlacklistMonitor_latest_check(
                        id = '', 
                        listed_on = [
                            ''
                            ], 
                ...
                check = mailodds.models.run_blacklist_check_200_response_check.runBlacklistCheck_200_response_check(
                    id = '', 
                    listed_on = [
                        ''
                        ], 
    ...
    def testRunBlacklistCheck200Response(self):
        """Test RunBlacklistCheck200Response"""
