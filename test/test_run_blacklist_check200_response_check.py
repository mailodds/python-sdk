...
class TestRunBlacklistCheck200ResponseCheck(unittest.TestCase):
    """RunBlacklistCheck200ResponseCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunBlacklistCheck200ResponseCheck:
        """Test RunBlacklistCheck200ResponseCheck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunBlacklistCheck200ResponseCheck`
        """
        model = RunBlacklistCheck200ResponseCheck()
        if include_optional:
    ...
    def testRunBlacklistCheck200ResponseCheck(self):
        """Test RunBlacklistCheck200ResponseCheck"""
