...
class TestRunServerTest201Response(unittest.TestCase):
    """RunServerTest201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunServerTest201Response:
        """Test RunServerTest201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunServerTest201Response`
        """
        model = RunServerTest201Response()
        if include_optional:
            return RunServerTest201Response(
                schema_version = '',
                request_id = '',
                test = mailodds.models.server_test.ServerTest(
                    id = '', 
                    domain = '', 
                    status = '', 
                    mx_records = [
                        mailodds.models.server_test_mx_records_inner.ServerTest_mx_records_inner(
                            host = '', 
                            priority = 56, 
                            ip = '', )
                        ], 
                    smtp_check = mailodds.models.server_test_smtp_check.ServerTest_smtp_check(
                        connectable = True, 
                        banner = '', 
                        starttls = True, 
                        response_time_ms = 56, ), 
                    dns_checks = mailodds.models.server_test_dns_checks.ServerTest_dns_checks(
                        spf = True, 
                        dkim = True, 
                        dmarc = True, 
                        dmarc_policy = '', ), 
    ...
    def testRunServerTest201Response(self):
        """Test RunServerTest201Response"""
