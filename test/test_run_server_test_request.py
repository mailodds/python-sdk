...
class TestRunServerTestRequest(unittest.TestCase):
    """RunServerTestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunServerTestRequest:
        """Test RunServerTestRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunServerTestRequest`
        """
        model = RunServerTestRequest()
        if include_optional:
    ...
    def testRunServerTestRequest(self):
        """Test RunServerTestRequest"""
