...
class TestRunSpamCheck201Response(unittest.TestCase):
    """RunSpamCheck201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunSpamCheck201Response:
        """Test RunSpamCheck201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunSpamCheck201Response`
        """
        model = RunSpamCheck201Response()
        if include_optional:
            return RunSpamCheck201Response(
                schema_version = '',
                request_id = '',
                spam_check = mailodds.models.spam_check.SpamCheck(
                    id = '', 
                    from_domain = '', 
                    score = 1.337, 
                    verdict = '', 
    ...
    def testRunSpamCheck201Response(self):
        """Test RunSpamCheck201Response"""
