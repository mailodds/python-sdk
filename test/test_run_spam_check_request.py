...
class TestRunSpamCheckRequest(unittest.TestCase):
    """RunSpamCheckRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunSpamCheckRequest:
        """Test RunSpamCheckRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunSpamCheckRequest`
        """
        model = RunSpamCheckRequest()
        if include_optional:
    ...
    def testRunSpamCheckRequest(self):
        """Test RunSpamCheckRequest"""
