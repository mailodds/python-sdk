...
class TestScheduleCampaignRequest(unittest.TestCase):
    """ScheduleCampaignRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleCampaignRequest:
        """Test ScheduleCampaignRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleCampaignRequest`
        """
        model = ScheduleCampaignRequest()
        if include_optional:
    ...
    def testScheduleCampaignRequest(self):
        """Test ScheduleCampaignRequest"""
