...
class TestSenderHealthApi(unittest.TestCase):
    """SenderHealthApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SenderHealthApi()

    def tearDown(self) -> None:
        pass

    def test_get_sender_health(self) -> None:
        """Test case for get_sender_health

        Get sender health score
        """
        pass

    def test_get_sender_health_trend(self) -> None:
        """Test case for get_sender_health_trend
