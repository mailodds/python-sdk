...
class TestSendingDomainDnsRecords(unittest.TestCase):
    """SendingDomainDnsRecords unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendingDomainDnsRecords:
        """Test SendingDomainDnsRecords
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendingDomainDnsRecords`
        """
        model = SendingDomainDnsRecords()
        if include_optional:
    ...
    def testSendingDomainDnsRecords(self):
        """Test SendingDomainDnsRecords"""
