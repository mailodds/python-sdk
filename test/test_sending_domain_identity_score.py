...
class TestSendingDomainIdentityScore(unittest.TestCase):
    """SendingDomainIdentityScore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendingDomainIdentityScore:
        """Test SendingDomainIdentityScore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendingDomainIdentityScore`
        """
        model = SendingDomainIdentityScore()
        if include_optional:
    ...
    def testSendingDomainIdentityScore(self):
        """Test SendingDomainIdentityScore"""
