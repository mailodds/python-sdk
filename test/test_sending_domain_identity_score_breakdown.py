...
class TestSendingDomainIdentityScoreBreakdown(unittest.TestCase):
    """SendingDomainIdentityScoreBreakdown unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendingDomainIdentityScoreBreakdown:
        """Test SendingDomainIdentityScoreBreakdown
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendingDomainIdentityScoreBreakdown`
        """
        ...
        if include_optional:
            return SendingDomainIdentityScoreBreakdown(
                ...
                spf = mailodds.models.identity_score_check.IdentityScoreCheck(
                    ...
                    max_points = 56, 
                    verified_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                dmarc = mailodds.models.identity_score_check.IdentityScoreCheck(
                    status = '', 
                    points = 56, 
                    max_points = 56, 
                    verified_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                ...
                return_path = mailodds.models.identity_score_check.IdentityScoreCheck(
                    ...
                    max_points = 56, 
                    verified_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                bimi = mailodds.models.identity_score_check.IdentityScoreCheck(
                    status = '', 
                    points = 56, 
                    max_points = 56, 
                    verified_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
    ...
    def testSendingDomainIdentityScoreBreakdown(self):
        """Test SendingDomainIdentityScoreBreakdown"""
