...
class TestServerTestDnsChecks(unittest.TestCase):
    """ServerTestDnsChecks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerTestDnsChecks:
        """Test ServerTestDnsChecks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerTestDnsChecks`
        """
        model = ServerTestDnsChecks()
        if include_optional:
    ...
    def testServerTestDnsChecks(self):
        """Test ServerTestDnsChecks"""
