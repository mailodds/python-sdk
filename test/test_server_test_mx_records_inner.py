...
class TestServerTestMxRecordsInner(unittest.TestCase):
    """ServerTestMxRecordsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerTestMxRecordsInner:
        """Test ServerTestMxRecordsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerTestMxRecordsInner`
        """
        model = ServerTestMxRecordsInner()
        if include_optional:
    ...
    def testServerTestMxRecordsInner(self):
        """Test ServerTestMxRecordsInner"""
