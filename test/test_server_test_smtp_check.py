...
class TestServerTestSmtpCheck(unittest.TestCase):
    """ServerTestSmtpCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerTestSmtpCheck:
        """Test ServerTestSmtpCheck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerTestSmtpCheck`
        """
        model = ServerTestSmtpCheck()
        if include_optional:
    ...
    def testServerTestSmtpCheck(self):
        """Test ServerTestSmtpCheck"""
