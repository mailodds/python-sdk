...
class TestServerTestsApi(unittest.TestCase):
    """ServerTestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ServerTestsApi()

    def tearDown(self) -> None:
        pass

    def test_get_server_test(self) -> None:
        """Test case for get_server_test

        Get server test
        """
        pass

    def test_list_server_tests(self) -> None:
        """Test case for list_server_tests

        List server tests
        """
        pass

    def test_run_server_test(self) -> None:
        """Test case for run_server_test
