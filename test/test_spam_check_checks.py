...
class TestSpamCheckChecks(unittest.TestCase):
    """SpamCheckChecks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpamCheckChecks:
        """Test SpamCheckChecks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpamCheckChecks`
        """
        model = SpamCheckChecks()
        if include_optional:
