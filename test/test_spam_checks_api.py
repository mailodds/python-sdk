...
class TestSpamChecksApi(unittest.TestCase):
    """SpamChecksApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SpamChecksApi()
    ...
    def test_list_spam_checks(self) -> None:
        """Test case for list_spam_checks

        List spam checks
        """
        pass

    def test_run_spam_check(self) -> None:
        """Test case for run_spam_check
