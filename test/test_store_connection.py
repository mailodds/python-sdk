...
class TestStoreConnection(unittest.TestCase):
    """StoreConnection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StoreConnection:
        """Test StoreConnection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoreConnection`
        """
