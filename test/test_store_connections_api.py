...
class TestStoreConnectionsApi(unittest.TestCase):
    """StoreConnectionsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = StoreConnectionsApi()
    ...
    def test_disconnect_store(self) -> None:
        """Test case for disconnect_store
