...
class TestStoreProduct(unittest.TestCase):
    """StoreProduct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StoreProduct:
        """Test StoreProduct
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoreProduct`
        """
        model = StoreProduct()
        if include_optional:
            return StoreProduct(
