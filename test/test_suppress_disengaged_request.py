...
class TestSuppressDisengagedRequest(unittest.TestCase):
    """SuppressDisengagedRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressDisengagedRequest:
        """Test SuppressDisengagedRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressDisengagedRequest`
        """
        model = SuppressDisengagedRequest()
        if include_optional:
    ...
    def testSuppressDisengagedRequest(self):
        """Test SuppressDisengagedRequest"""
