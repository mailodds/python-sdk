...
class TestSuppressionAuditResponse(unittest.TestCase):
    """SuppressionAuditResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressionAuditResponse:
        """Test SuppressionAuditResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressionAuditResponse`
        """
        model = SuppressionAuditResponse()
        if include_optional:
            return SuppressionAuditResponse(
                schema_version = '',
                request_id = '',
                entries = [
                    mailodds.models.suppression_audit_response_entries_inner.SuppressionAuditResponse_entries_inner(
                        id = 56, 
                        event_type = '', 
                        event_category = '', 
                        details = mailodds.models.details.details(), 
    ...
    def testSuppressionAuditResponse(self):
        """Test SuppressionAuditResponse"""
