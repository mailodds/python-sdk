...
class TestSuppressionAuditResponseEntriesInner(unittest.TestCase):
    """SuppressionAuditResponseEntriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressionAuditResponseEntriesInner:
        """Test SuppressionAuditResponseEntriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressionAuditResponseEntriesInner`
        """
        model = SuppressionAuditResponseEntriesInner()
        if include_optional:
    ...
    def testSuppressionAuditResponseEntriesInner(self):
        """Test SuppressionAuditResponseEntriesInner"""
