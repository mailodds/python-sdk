...
class TestUnsubscribeSubscriber200Response(unittest.TestCase):
    """UnsubscribeSubscriber200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnsubscribeSubscriber200Response:
        """Test UnsubscribeSubscriber200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnsubscribeSubscriber200Response`
        """
        model = UnsubscribeSubscriber200Response()
        if include_optional:
            return UnsubscribeSubscriber200Response(
                subscriber = mailodds.models.subscriber.Subscriber(
                    id = '', 
                    list_id = '', 
                    email = '', 
                    name = '', 
    ...
    def testUnsubscribeSubscriber200Response(self):
        """Test UnsubscribeSubscriber200Response"""
