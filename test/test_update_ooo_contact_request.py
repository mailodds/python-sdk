...
class TestUpdateOooContactRequest(unittest.TestCase):
    """UpdateOooContactRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateOooContactRequest:
        """Test UpdateOooContactRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateOooContactRequest`
        """
        model = UpdateOooContactRequest()
        if include_optional:
            return UpdateOooContactRequest(
                is_active = True,
                ooo_type = 'out_of_office',
                duration_days = 1
            )
        else:
            return UpdateOooContactRequest(
    ...
    def testUpdateOooContactRequest(self):
        """Test UpdateOooContactRequest"""
