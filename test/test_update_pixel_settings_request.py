...
class TestUpdatePixelSettingsRequest(unittest.TestCase):
    """UpdatePixelSettingsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePixelSettingsRequest:
        """Test UpdatePixelSettingsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePixelSettingsRequest`
        """
        model = UpdatePixelSettingsRequest()
        if include_optional:
    ...
    def testUpdatePixelSettingsRequest(self):
        """Test UpdatePixelSettingsRequest"""
