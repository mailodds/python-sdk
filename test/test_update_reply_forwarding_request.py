...
class TestUpdateReplyForwardingRequest(unittest.TestCase):
    """UpdateReplyForwardingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateReplyForwardingRequest:
        """Test UpdateReplyForwardingRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateReplyForwardingRequest`
        """
        model = UpdateReplyForwardingRequest()
        if include_optional:
    ...
    def testUpdateReplyForwardingRequest(self):
        """Test UpdateReplyForwardingRequest"""
