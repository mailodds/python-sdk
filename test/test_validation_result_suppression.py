...
class TestValidationResultSuppression(unittest.TestCase):
    """ValidationResultSuppression unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidationResultSuppression:
        """Test ValidationResultSuppression
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationResultSuppression`
        """
        model = ValidationResultSuppression()
        if include_optional:
    ...
    def testValidationResultSuppression(self):
        """Test ValidationResultSuppression"""
