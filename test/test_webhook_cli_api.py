...
class TestWebhookCLIApi(unittest.TestCase):
    """WebhookCLIApi unit test stubs"""

    def setUp(self) -> None:
        self.api = WebhookCLIApi()

    def tearDown(self) -> None:
        pass

    def test_create_webhook_cli_session(self) -> None:
        """Test case for create_webhook_cli_session

        Create CLI forwarding session
        """
        pass

    def test_delete_webhook_cli_session(self) -> None:
        """Test case for delete_webhook_cli_session
    ...
    def test_replay_webhook_delivery(self) -> None:
        """Test case for replay_webhook_delivery
